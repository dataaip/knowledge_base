...
int varle(void) {
  ...
  */
  ...
  print_green("定宽整数类型:\n");
  printf("有符号定宽整数类型: "
         "int8_t~int64_t(宽度正好是8~64位的有符号整数类型)、int_fast8_t~int_fast64_t(宽度至少有8~64位的最快的有符号整数类型)、int_least8_t~int_least64_"
         "t(宽度至少有8~64位的最小的有符号整数类型)、intmax_t、intptr_t (C99起).\n");
  printf("无符号定宽整数类型: "
