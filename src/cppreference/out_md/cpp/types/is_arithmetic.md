...
|  |
| --- |
| ```text template<class T> struct is_arithmetic : std::integral_constant<bool,                                               std::is_integral<T>::value ||                                               std::is_floating_point<T>::value> {}; ``` |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_arithmetic&oldid=158175>"
...
- This page was last modified on 7 September 2023, at 15:44.