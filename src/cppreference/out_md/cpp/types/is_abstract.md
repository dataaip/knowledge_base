...
|  |  |
| --- | --- |
| value[static] | true if `T` is an abstract class type, false otherwise   (public static member constant) |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_abstract&oldid=159389>"
