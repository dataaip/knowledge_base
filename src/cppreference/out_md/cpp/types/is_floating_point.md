...
|  |  |
| --- | --- |
| value[static] | true if `T` is a floating-point type (possibly cv-qualified), false otherwise   (public static member constant) |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_floating_point&oldid=176473>"
...
- This page was last modified on 24 September 2024, at 13:50.