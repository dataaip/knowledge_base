...
| `typeid` | Queries information of a type, returning a `std::type_info` object representing the type (built-in operator) |
...
- This page was last modified on 28 April 2023, at 04:21.