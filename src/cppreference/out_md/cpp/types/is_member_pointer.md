...
|  |  |  |
| --- | --- | --- |
| template< class T >  constexpr bool is_member_pointer_v = is_member_pointer<T>::value; |  | (since C++17) |
|  |  |  |
...
|  |  |
| --- | --- |
| value[static] | true if `T` is a member pointer type, false otherwise   (public static member constant) |
...
|  |
| --- |
| ```text template<class T> struct is_member_pointer_helper : std::false_type {};   template<class T, class U> struct is_member_pointer_helper<T U::*> : std::true_type {};   template<class T> struct is_member_pointer : is_member_pointer_helper<typename std::remove_cv<T>::type> {}; ``` |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_member_pointer&oldid=176539>"
...
- This page was last modified on 26 September 2024, at 05:08.