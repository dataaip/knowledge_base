...
|  |  |  |
| --- | --- | --- |
| constexpr std::size_t /\*fwd-prod-of-extents\*/( rank_type i ) const noexcept; |  | (since C++23)  (exposition only\*) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/extents/fwd-prod-of-extents&oldid=178726>"
