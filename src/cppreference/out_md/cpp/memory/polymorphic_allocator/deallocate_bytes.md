...
|  |  |  |
| --- | --- | --- |
| void deallocate_bytes( void\* p,  std::size_t nbytes, std::size_t alignment = alignof(std::max_align_t) ); |  | (since C++20) |
|  |  |  |
...
- This page was last modified on 18 July 2023, at 04:19.