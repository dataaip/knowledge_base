...
| do_deallocate[virtual] | deallocates memory (virtual private member function of `std::pmr::memory_resource`) |

Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/memory/unsynchronized_pool_resource/do_deallocate&oldid=155528>"
...
- This page was last modified on 26 July 2023, at 21:01.