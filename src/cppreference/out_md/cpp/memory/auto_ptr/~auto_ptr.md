...
|  |  |  |
| --- | --- | --- |
| ~auto_ptr() throw(); |  | (deprecated in C++11)  (removed in C++17) |
|  |  |  |

Destroys the managed object. Calls delete get().

Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/memory/auto_ptr/%7Eauto_ptr&oldid=154304>"
...
- This page was last modified on 29 June 2023, at 01:54.