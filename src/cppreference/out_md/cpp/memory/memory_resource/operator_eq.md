...
| bool operator==( const std::pmr::memory_resource& a,                   const std::pmr::memory_resource& b ) noexcept; | (1) | (since C++17) |
| bool operator!=( const std::pmr::memory_resource& a,                   const std::pmr::memory_resource& b ) noexcept; | (2) | (since C++17)  (until C++20) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/memory/memory_resource/operator_eq&oldid=155233>"
...
- This page was last modified on 19 July 2023, at 21:12.