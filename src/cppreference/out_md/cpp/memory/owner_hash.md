...
|  |  |  |
| --- | --- | --- |
| template< class T >  std::size_t operator()( const std::shared_ptr<T>& key ) const noexcept; | (1) | (since C++26) |
| template< class T >  std::size_t operator()( const std::weak_ptr<T>& key ) const noexcept; | (2) | (since C++26) |
|  |  |  |
...
|  |  |
| --- | --- |
| owner_hash(C++26) | provides owner-based hashing of shared pointers   (public member function of `std::shared_ptr<T>`) |
| owner_hash(C++26) | provides owner-based hashing of weak pointers   (public member function of `std::weak_ptr<T>`) |
...
- This page was last modified on 30 April 2024, at 05:08.