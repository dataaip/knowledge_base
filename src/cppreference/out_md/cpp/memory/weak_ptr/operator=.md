...
1-3) Equivalent to std::weak_ptr<T>(r).swap(\*this).4,5) Equivalent to std::weak_ptr<T>(std::move(r)).swap(\*this).
...
- This page was last modified on 23 June 2023, at 23:11.