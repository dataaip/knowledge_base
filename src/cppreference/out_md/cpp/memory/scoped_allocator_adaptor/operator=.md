...
1) Explicitly defaulted copy assignment operator that copy assigns the base class (`OuterAlloc`, the outer allocator) and all inner allocators.2) Explicitly defaulted move assignment operator that move assigns the base class (`OuterAlloc`, the outer allocator) and all inner allocators.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/memory/scoped_allocator_adaptor/operator%3D&oldid=156551>"
...
- This page was last modified on 11 August 2023, at 13:29.