...
|  |  |  |
| --- | --- | --- |
| typename std::add_lvalue_reference<T>::type operator\*() const      noexcept(noexcept(\*std::declval<pointer>())); | (1) | (since C++11)  (constexpr since C++23) |
...
1) Returns the object owned by \*this, equivalent to \*get().2) Returns a pointer to the object owned by \*this, i.e. get().
...
Retrieved from "https://en.cppreference.com/mwiki/index.php?title=cpp/memory/unique_ptr/operator\*&oldid=164400"
...
- This page was last modified on 29 November 2023, at 23:27.