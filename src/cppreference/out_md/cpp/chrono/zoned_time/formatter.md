...
| template< class Duration, class TimeZonePtr, class CharT >  struct formatter<std::chrono::zoned_time<Duration, TimeZonePtr>, CharT> : std::formatter</\*local-time-format-t\*/<Duration>, CharT> |  | (since C++20) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/zoned_time/formatter&oldid=161725>"
...
- This page was last modified on 29 October 2023, at 10:36.