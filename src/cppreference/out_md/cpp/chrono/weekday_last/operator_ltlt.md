...
| template< class CharT, class Traits >  std::basic_ostream<CharT, Traits>&     operator<<( std::basic_ostream<CharT, Traits>& os, const std::chrono::weekday_last& wdl ); |  | (since C++20) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/weekday_last/operator_ltlt&oldid=161683>"
...
- This page was last modified on 29 October 2023, at 04:42.