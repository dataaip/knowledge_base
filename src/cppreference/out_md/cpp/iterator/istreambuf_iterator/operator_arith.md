...
1) \*this2) A `proxy` object holding the current character obtained via operator\*() and the `sbuf_` pointer. Dereferencing a `proxy` object with `operator*` yields the stored character. The name `proxy` is for exposition only.

### Exceptions

May throw implementation-defined exceptions.

Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/istreambuf_iterator/operator_arith&oldid=159920>"
...
- This page was last modified on 1 October 2023, at 00:01.