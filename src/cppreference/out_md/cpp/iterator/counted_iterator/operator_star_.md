...
1,2) Returns a reference to the current element. The behavior is undefined if this->count() <= 0. The function's body is equivalent to return \*current;.3) Returns a pointer to the current element. The function's body is equivalent to return std::to_address(current);.
...
|  |  |
| --- | --- |
| [operator[]](operator_at.html "cpp/iterator/counted iterator/operator at")(C++20) | accesses an element by index   (public member function) |

Retrieved from "https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/counted_iterator/operator\*&oldid=159840"
...
- This page was last modified on 29 September 2023, at 23:42.