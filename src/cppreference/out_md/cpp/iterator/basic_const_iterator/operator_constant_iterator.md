...
|  |  |  |
| --- | --- | --- |
| template< /\*not-a-const-iterator\*/ CI >    requires /\*constant-iterator\*/<CI> &&         std::convertible_to<Iter const&, CI> constexpr operator CI() const &; | (1) | (since C++23) |
| template< /\*not-a-const-iterator\*/ CI >    requires /\*constant-iterator\*/<CI> &&         std::convertible_to<Iter, CI> constexpr operator CI() &&; | (2) | (since C++23) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/basic_const_iterator/operator_constant_iterator&oldid=175483>"
...
- This page was last modified on 23 August 2024, at 19:59.