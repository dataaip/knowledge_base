...
|  |  |
| --- | --- |
| base(C++11) | accesses the underlying iterator   (public member function of `std::move_iterator<Iter>`) |

Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/move_sentinel/base&oldid=123278>"
