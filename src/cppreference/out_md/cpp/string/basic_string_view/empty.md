...
| empty | checks whether the string is empty   (public member function of `std::basic_string<CharT,Traits,Allocator>`) |

Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string_view/empty&oldid=173030>"
...
- This page was last modified on 1 July 2024, at 02:57.