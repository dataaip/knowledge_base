...
1) Public member function, calls the member function `do_grouping` of the most derived class.2) Returns the pattern that determines the grouping of the digits in the monetary output, with the same exact meaning as std::numpunct::do_grouping.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/locale/moneypunct/grouping&oldid=160153>"
...
- This page was last modified on 4 October 2023, at 11:07.