...
|  |
| --- |
| ```text template<class CharT> bool isgraph(CharT ch, const std::locale& loc) {     return std::use_facet<std::ctype<CharT>>(loc).is(std::ctype_base::graph, ch); } ``` |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/locale/isgraph&oldid=160081>"
...
- This page was last modified on 3 October 2023, at 10:27.