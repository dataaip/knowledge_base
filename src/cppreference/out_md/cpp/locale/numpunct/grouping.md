...
1) Public member function, calls the member function `do_grouping` of the most derived class.2) Returns an std::string holding, in each char element, the number of digits in each group of the numeric output formatted by num_put::put() (and, therefore, basic_ostream::operator<<).
...
- This page was last modified on 8 October 2023, at 07:51.