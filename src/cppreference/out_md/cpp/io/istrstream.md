...
| class istrstream : public std::istream |  | (deprecated in C++98)  (removed in C++26) |
|  |  |  |
...
|  |  |
| --- | --- |
| (constructor) | constructs an `istrstream` object, optionally allocating the buffer   (public member function) |
| (destructor)[virtual] | destructs an `istrstream` object, optionally deallocating the buffer   (virtual public member function) |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/io/istrstream&oldid=170659>"
...
- This page was last modified on 6 April 2024, at 07:09.