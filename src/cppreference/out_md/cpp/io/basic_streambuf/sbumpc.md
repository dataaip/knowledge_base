...
| --- | --- | --- |
| int_type sbumpc(); | (1) |  |
| void stossc(); | (2) | (deprecated in C++98)  (removed in C++17) |
|  |  |  |

Reads one character and advances the input sequence by one character.

1) If the input sequence read position is not available, returns uflow(). Otherwise returns Traits::to_int_type(\*gptr()).2) Same as (1), but discards the result.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_streambuf/sbumpc&oldid=130724>"
...
- This page was last modified on 24 June 2021, at 10:01.