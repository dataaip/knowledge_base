...
|  |  |
| --- | --- |
| operator= | assigns a `basic_osyncstream` object   (public member function of `std::basic_osyncstream<CharT,Traits,Allocator>`) |
...
- This page was last modified on 10 October 2022, at 10:41.