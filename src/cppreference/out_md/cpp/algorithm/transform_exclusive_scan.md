...
1) Computes the exclusive prefix sum using op. For each integer i in ``​0​`,`[std::distance(first, last)`)`, performs the following operations in order:
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/transform_exclusive_scan&oldid=171039>"
...
- This page was last modified on 18 April 2024, at 22:39.