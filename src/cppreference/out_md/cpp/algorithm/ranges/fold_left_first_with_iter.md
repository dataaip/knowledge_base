...
1) The range is `[`first`,`last`)`.2) Same as (1), except that uses r as the range, as if by using [ranges::begin(r) as first and ranges::end(r) as last.3) Equivalent to:
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_left_first_with_iter&oldid=171185>"
...
- This page was last modified on 23 April 2024, at 07:57.