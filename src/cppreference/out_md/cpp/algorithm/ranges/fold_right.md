...
Right-folds "enwiki:Fold (higher-order function)") the elements of given range, that is, returns the result of evaluation of the chain expression:  
...
An object of type U that contains the result of right-fold "enwiki:Fold (higher-order function)") of the given range over f, where U is equivalent to std::decay_t<std::invoke_result_t<F&, std::iter_reference_t<I>, T>>;.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_right&oldid=176215>"
...
- This page was last modified on 16 September 2024, at 02:30.