...
| --- | --- | --- |
|  | (1) |  |
| private:  mask_array(); |  | (until C++11) |
| public:  mask_array() = delete; |  | (since C++11) |
|  |  |  |
| --- | --- | --- |
| public:  mask_array( const mask_array& other ); | (2) |  |
|  |  |  |

1) The default constructor is declared private and not defined(until C++11)explicitly defined as deleted(since C++11): `mask_array` is not DefaultConstructible.2) Constructs a `mask_array` from another `mask_array` other.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/valarray/mask_array/mask_array&oldid=120741>"
