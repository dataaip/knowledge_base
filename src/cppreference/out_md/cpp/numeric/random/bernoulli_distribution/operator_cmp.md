...
|  |  |  |
| --- | --- | --- |
| friend bool operator==( const bernoulli_distribution& lhs,                          const bernoulli_distribution& rhs ); | (1) | (since C++11) |
| friend bool operator!=( const bernoulli_distribution& lhs,                          const bernoulli_distribution& rhs ); | (2) | (since C++11)  (until C++20) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/bernoulli_distribution/operator_cmp&oldid=129754>"
...
- This page was last modified on 10 June 2021, at 00:58.