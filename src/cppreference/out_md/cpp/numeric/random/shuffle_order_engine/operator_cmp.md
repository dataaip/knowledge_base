...
|  |  |  |
| --- | --- | --- |
| friend bool operator==( const shuffle_order_engine& lhs,                          const shuffle_order_engine& rhs ); | (1) | (since C++11) |
| friend bool operator!=( const shuffle_order_engine& lhs,                          const shuffle_order_engine& rhs ); | (2) | (since C++11)  (until C++20) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/shuffle_order_engine/operator_cmp&oldid=132176>"
