...
|  |  |  |
| --- | --- | --- |
| friend bool operator==( const geometric_distribution& lhs,                          const geometric_distribution& rhs ); | (1) | (since C++11) |
| friend bool operator!=( const geometric_distribution& lhs,                          const geometric_distribution& rhs ); | (2) | (since C++11)  (until C++20) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/geometric_distribution/operator_cmp&oldid=132437>"
