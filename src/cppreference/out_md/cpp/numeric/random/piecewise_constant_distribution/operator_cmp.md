...
|  |  |  |
| --- | --- | --- |
| friend bool operator==( const piecewise_constant_distribution& lhs,                          const piecewise_constant_distribution& rhs ); | (1) | (since C++11) |
| friend bool operator!=( const piecewise_constant_distribution& lhs,                          const piecewise_constant_distribution& rhs ); | (2) | (since C++11)  (until C++20) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/piecewise_constant_distribution/operator_cmp&oldid=135817>"
