...
1) Returns the list of boundaries of the intervals.2) Returns the list of probability densities at the boundaries of the intervals.
...
1) The list of boundaries of the intervals.2) The list of probability densities at the boundaries of the intervals.

### Complexity

Linear in the number of intervals in this object.

Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/piecewise_linear_distribution/params&oldid=139763>"
...
- This page was last modified on 21 May 2022, at 08:37.