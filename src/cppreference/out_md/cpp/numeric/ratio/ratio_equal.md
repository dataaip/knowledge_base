...
| template< class R1, class R2 >  struct ratio_equal : std::integral_constant<bool, /\* see below \*/> { }; |  | (since C++11) |
|  |  |  |
...
|  |
| --- |
| ```text template< class R1, class R2 > struct ratio_equal : public std::integral_constant <                                  bool,                                  R1::num == R2::num && R1::den == R2::den                             > {}; ``` |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/ratio/ratio_equal&oldid=176482>"
...
- This page was last modified on 24 September 2024, at 14:46.