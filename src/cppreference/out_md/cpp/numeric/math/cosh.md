...
|  |  |
| --- | --- |
| S) The SIMD overload performs an element-wise `std::cosh` on v_num. (See **math-floating-point** and **deduced-simd-t** for their definitions.) | (since C++26) |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/cosh&oldid=160748>"
...
- This page was last modified on 15 October 2023, at 09:48.