...
| template< /\*math-floating-point\*/ V >  constexpr /\*deduced-simd-t\*/<V>             atanh ( const V& v_num ); | (S) | (since C++26) |
...
|  |  |
| --- | --- |
| S) The SIMD overload performs an element-wise `std::atanh` on v_num. (See **math-floating-point** and **deduced-simd-t** for their definitions.) | (since C++26) |
...
- This page was last modified on 15 October 2023, at 09:52.