...
|  |  |  |
| --- | --- | --- |
| void store( T desired, std::memory_order order =                             std::memory_order_seq_cst ) noexcept; | (1) | (since C++11) |
| void store( T desired, std::memory_order order =                             std::memory_order_seq_cst ) volatile noexcept; | (2) | (since C++11) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic/store&oldid=159435>"
...
- This page was last modified on 20 September 2023, at 23:08.