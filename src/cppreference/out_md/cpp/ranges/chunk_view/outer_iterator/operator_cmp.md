...
|  |  |  |
| --- | --- | --- |
| friend constexpr bool      operator==( const /\*outer-iterator\*/& x, std::default_sentinel_t ); |  | (since C++23) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/outer_iterator/operator_cmp&oldid=172672>"
