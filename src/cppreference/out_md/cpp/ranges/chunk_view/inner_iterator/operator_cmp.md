...
|  |  |  |
| --- | --- | --- |
| friend constexpr bool operator==( const /\*inner-iterator\*/& x,                                    std::default_sentinel_t ); |  | (since C++23) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/inner_iterator/operator_cmp&oldid=172670>"
...
- This page was last modified on 20 June 2024, at 21:15.