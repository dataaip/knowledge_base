...
|  |  |  |
| --- | --- | --- |
| constexpr decltype(auto) operator\*() const      noexcept(/\* see description \*/); |  | (since C++23) |
|  |  |  |
...
noexcept specification:noexcept(std::invoke(\*parent_->fun_, \*std::get<INTS>(inner_.current_)...))
...
Retrieved from "https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/zip_transform_view/iterator/operator\*&oldid=142003"
...
- This page was last modified on 13 August 2022, at 10:43.