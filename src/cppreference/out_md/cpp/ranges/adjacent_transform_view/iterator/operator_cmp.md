...
| friend constexpr auto operator<=>( const /\*iterator\*/& x, const /\*iterator\*/& y )      requires ranges::random_access_range<Base> and std::three_way_comparable<ranges::iterator_t<Base>>; | (6) | (since C++23) |
|  |  |  |

Compares the underlying iterators: `inner_`.

1) Equivalent to return x.inner_ == y.inner_;.2) Equivalent to return x.inner_ < y.inner_;.3) Equivalent to return x.inner_ > y.inner_;.4) Equivalent to return x.inner_ <= y.inner_;.5) Equivalent to return x.inner_ >= y.inner_;.6) Equivalent to return x.inner_ <=> y.inner_;.
...
|  |  |
| --- | --- |
| operator==(C++23) | compares a sentinel with an iterator returned from adjacent_transform_view::begin   (function) |

Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/adjacent_transform_view/iterator/operator_cmp&oldid=172652>"
...
- This page was last modified on 20 June 2024, at 20:47.