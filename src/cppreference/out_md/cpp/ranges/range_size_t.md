...
1) Used to obtain the size type of the `sized_range` type `R`.2) Used to obtain the difference type of the iterator type of range type `R`.3) Used to obtain the value type of the iterator type of range type `R`.
...
- This page was last modified on 29 August 2024, at 10:18.