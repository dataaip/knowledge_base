...
|  |  |  |
| --- | --- | --- |
| constexpr decltype(auto) operator[]( difference_type n ) const      requires ranges::random_access_range<Base> |  | (since C++23) |
|  |  |  |
...
|  |  |
| --- | --- |
| operator\*(C++23) | accesses an element   (public member function) |

Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/stride_view/iterator/operator_at&oldid=156888>"
...
- This page was last modified on 16 August 2023, at 22:37.