...
|  |  |  |
| --- | --- | --- |
| friend constexpr ranges::range_rvalue_reference_t<Base>      iter_move( const /\*iterator\*/& i ) noexcept(/\* see below \*/); |  | (since C++23) |
|  |  |  |
...
noexcept specification:noexcept(noexcept(ranges::iter_move(i.current_)))
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/stride_view/iterator/iter_move&oldid=172645>"
...
- This page was last modified on 20 June 2024, at 20:32.