...
|  |  |  |
| --- | --- | --- |
| template< bool OtherConst >      requires (std::sentinel_for<          ranges::sentinel_t</\*maybe-const\*/<Const, Views>>,          ranges::iterator_t</\*maybe-const\*/<OtherConst, Views>>> && ...)  friend constexpr bool operator==( const /\*iterator\*/<OtherConst>& x, const /\*sentinel\*/& y  ); |  | (since C++23) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/zip_view/sentinel/operator_cmp&oldid=172680>"
...
- This page was last modified on 20 June 2024, at 21:39.