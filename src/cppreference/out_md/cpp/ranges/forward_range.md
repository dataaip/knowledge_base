...
| template< class T >  concept forward_range = ranges::input_range<T> && std::forward_iterator<ranges::iterator_t<T>>; |  | (since C++20) |
|  |  |  |
...
- This page was last modified on 12 February 2024, at 15:22.