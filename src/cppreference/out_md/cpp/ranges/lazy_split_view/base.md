...
|  |  |
| --- | --- |
| base | returns a copy of the underlying (adapted) view   (public member function of `std::ranges::split_view<V,Pattern>`) |
...
- This page was last modified on 28 January 2025, at 14:30.