...
| constexpr /\*iterator\*/ operator++( int )      requires /\*ref-is-glvalue\*/ && ranges::forward_range<Base> && ranges::forward_range<ranges::range_reference_t<Base>>; | (3) | (since C++20) |
| constexpr iterator& operator--()      requires /\*ref-is-glvalue\*/ && ranges::bidirectional_range<Base> &&               ranges::bidirectional_range<ranges::range_reference_t<Base>> && ranges::common_range<ranges::range_reference_t<Base>>; | (4) | (since C++20) |
| constexpr /\*iterator\*/ operator--( int )      requires /\*ref-is-glvalue\*/ && ranges::bidirectional_range<Base> &&               ranges::bidirectional_range<ranges::range_reference_t<Base>> && ranges::common_range<ranges::range_reference_t<Base>>; | (5) | (since C++20) |
|  |  |  |
...
2) Equivalent to: ++\*this.3) Equivalent to:
...
1,4) \*this2) (none)3,5) a copy of \*this that was made before the change.
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/join_view/iterator/operator_arith&oldid=175909>"
...
- This page was last modified on 8 September 2024, at 11:49.