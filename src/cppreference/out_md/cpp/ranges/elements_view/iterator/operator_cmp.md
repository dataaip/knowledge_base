...
1) Equivalent to return x.base() == y.base();.2) Equivalent to return x.base() < y.base();.3) Equivalent to return y < x;.4) Equivalent to return !(y < x);.5) Equivalent to return !(x < y);.6) Equivalent to return x.base() <=> y.base();.
...
|  |  |
| --- | --- |
| operator==(C++20) | compares a sentinel with an iterator returned from elements_view::begin   (function) |

Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/elements_view/iterator/operator_cmp&oldid=172721>"
...
- This page was last modified on 21 June 2024, at 09:27.