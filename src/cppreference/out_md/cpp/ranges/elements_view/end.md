...
|  |  |  |
| --- | --- | --- |
| constexpr auto end() requires (!/\*simple-view\*/<V> && !ranges::common_range<V>); | (1) | (since C++20) |
...
1) return /\*sentinel\*/<false>{ranges::end(base_)};.2) return /\*iterator\*/<false>{ranges::end(base_)};.3) return /\*sentinel\*/<true>{ranges::end(base_)};.4) return /\*iterator\*/<true>{ranges::end(base_)};.
...
- This page was last modified on 13 July 2024, at 11:12.