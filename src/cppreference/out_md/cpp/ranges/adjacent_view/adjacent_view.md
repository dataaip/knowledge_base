...
|  |  |  |
| --- | --- | --- |
| adjacent_view() requires std::default_initializable<V> = default; | (1) | (since C++23) |
| constexpr explicit adjacent_view( V base ); | (2) | (since C++23) |
|  |  |  |

Constructs an `adjacent_view`.

1) Default constructor. Value-initializes the underlying view.2) Initializes the underlying view `base_` with std::move(base).
...
- This page was last modified on 17 October 2023, at 21:16.