...
1) Equivalent to return /\*iterator\*/<false>{\*this, ranges::begin(base_)};, where `base_` is the underlying view.2) Equivalent to return /\*iterator\*/<true>{\*this, ranges::begin(base_)};, where `base_` is the underlying view.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/transform_view/begin&oldid=173541>"
...
- This page was last modified on 13 July 2024, at 01:28.