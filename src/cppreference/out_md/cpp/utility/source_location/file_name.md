...
| source_file | gets the name of the source file that lexically contains the expression or statement whose evaluation is represented by the `stacktrace_entry`   (public member function of `std::stacktrace_entry`) |
| Filename and line information | |

Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/utility/source_location/file_name&oldid=150209>"
...
- This page was last modified on 6 April 2023, at 22:12.