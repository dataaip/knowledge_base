...
| template< class... Types >  struct tuple_size< std::tuple<Types...> > : std::integral_constant<std::size_t, sizeof...(Types)> { }; |  | (since C++11) |
|  |  |  |
...
- This page was last modified on 24 September 2024, at 09:04.