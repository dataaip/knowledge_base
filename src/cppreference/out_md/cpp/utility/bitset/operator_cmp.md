...
1) Returns true if all of the bits in \*this and rhs are equal.2) Returns true if any of the bits in \*this and rhs are not equal.
...
1) true if the value of each bit in \*this equals the value of the corresponding bit in rhs, otherwise false.2) true if !(\*this == rhs), otherwise false.
...
- This page was last modified on 13 May 2024, at 19:53.