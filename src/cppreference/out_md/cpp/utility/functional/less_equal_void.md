...
| template<>  class less_equal<void>; |  | (since C++14) |
|  |  |  |
...
|  |  |
| --- | --- |
| ****operator()**** | tests if lhs compares less or equal than rhs   (public member function) |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/less_equal_void&oldid=171016>"
...
- This page was last modified on 18 April 2024, at 01:28.