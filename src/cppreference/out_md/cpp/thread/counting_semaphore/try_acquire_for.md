...
|  |  |  |
| --- | --- | --- |
| template< class Rep, class Period >  bool try_acquire_for( const std::chrono::duration<Rep, Period>& rel_time ); |  | (since C++20) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/thread/counting_semaphore/try_acquire_for&oldid=161129>"
...
- This page was last modified on 22 October 2023, at 08:54.