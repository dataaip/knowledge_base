...
|  |  |  |
| --- | --- | --- |
| template< class Clock, class Duration >  bool try_acquire_until( const std::chrono::time_point<Clock, Duration>& abs_time ); |  | (since C++20) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/thread/counting_semaphore/try_acquire_until&oldid=161130>"
...
- This page was last modified on 22 October 2023, at 08:55.