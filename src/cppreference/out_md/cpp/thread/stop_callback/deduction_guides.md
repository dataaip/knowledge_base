...
| template< class Callback >  stop_callback( std::stop_token, Callback ) -> stop_callback<Callback>; |  | (since C++20) |
|  |  |  |
...
- This page was last modified on 23 October 2023, at 10:39.