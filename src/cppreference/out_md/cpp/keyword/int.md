...
|  |  |
| --- | --- |
| - `long long int` type: as the declaration of the type when combined with two `long`s - `unsigned long long int` type: as the declaration of the type when combined with `unsigned` and two `long`s | (since C++11) |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/int&oldid=175629>"
...
- This page was last modified on 1 September 2024, at 06:48.