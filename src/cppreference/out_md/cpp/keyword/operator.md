...
- name of an overloaded operator function
- name of a user-defined conversion function
- name of an allocation function
- name of a deallocation function

|  |  |
| --- | --- |
| - name of a literal operator function | (since C++11) |

Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/operator&oldid=175039>"
...
- This page was last modified on 14 August 2024, at 01:05.