...
| 使 `()` 在 lambda 中更可选 | P1102R2 | 11 | 13 |  | 13.1.6\* | 6.3 | 2022.2 | 22.5 |  |  |
...
| 在换行拼接前修剪空白 | P2223R2 | Yes | Yes |  | Yes | 6.7 | 2022.2 | Yes |  |  |
| 使声明顺序布局成为强制要求 | P1847R4 | Yes | Yes | Yes | Yes |  | 2022.2 | Yes |  |  |
| 移除混合宽字符串字面量连接 | P2201R1 | Yes | Yes | Yes | Yes | Yes | Yes | Yes |  |  |
| 显式对象成员函数（deducing this） | P0847R7 | 14 | 18 19\* | 19.32\* (部分)\* |  | 6.3 |  | 22.5 |  |  |
| `auto(x)` 和 `auto{x}` | P0849R8 | 12 | 15 |  | 14.0.3\* | 6.4 | 2022.2 | 23.3 |  |  |
| `#elifdef` 和 `#elifndef` | P2334R1 | 12 | 13 | 19.40\* | 13.1.6\* | 6.5 | 2022.2 | 23.9 |  |  |
| constexpr 函数中的非字面量变量（以及标签和 goto） | P2242R3 | 12 | 15 |  | 14.0.3\* | 6.3 | 2022.2 | 22.5 |  |  |
...
| lambda 的属性 | P2173R1 | 9 | 13 |  | 13.1.6\* | 6.6 | 2022.2 | 22.5 |  |  |
...
| DR20: 为非 const-formattable 类型添加 std::format 支持 | P2418R2 | 13 | 15 | 19.32\* | 14.0.3\* |
| DR20: std::basic_format_string | P2508R1 | 13 | 15 | 19.35\* | 14.0.3\* |
| DR20: Poison Pills 太有毒了 | P2602R2 | 14 | 19 | 19.36\* |  |
