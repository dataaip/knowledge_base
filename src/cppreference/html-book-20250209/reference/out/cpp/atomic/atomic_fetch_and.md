...
1,2) obj->fetch_and(arg)3,4) obj->fetch_and(arg, order)
...
|  |  |
| --- | --- |
| fetch_and | atomically performs bitwise AND between the argument and the value of the atomic object and obtains the value held previously   (public member function of `std::atomic<T>`) |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_fetch_and&oldid=161342>"
