...
1) operator+= performs atomic addition. Equivalent to return fetch_add(arg) + arg;.2) operator-= performs atomic subtraction. Equivalent to return fetch_sub(arg) - arg;.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_ref/operator_arith2&oldid=179600>"
...
- This page was last modified on 13 January 2025, at 14:51.