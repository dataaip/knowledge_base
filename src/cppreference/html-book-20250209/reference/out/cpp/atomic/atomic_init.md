...
| template< class T >  void atomic_init      ( std::atomic<T>\* obj, typename std::atomic<T>::value_type desired ) noexcept; | (1) | (since C++11)  (deprecated in C++20) |
...
| (constructor) | constructs an atomic object   (public member function of `std::atomic<T>`) |
...
- This page was last modified on 20 September 2023, at 22:45.