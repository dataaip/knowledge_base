...
| void atomic_flag_notify_all( std::atomic_flag\* object ) noexcept; | (1) | (since C++20) |
| void atomic_flag_notify_all( volatile std::atomic_flag\* object ) noexcept; | (2) | (since C++20) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_flag_notify_all&oldid=159570>"
...
- This page was last modified on 25 September 2023, at 00:12.