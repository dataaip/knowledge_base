...
| --- | --- |
| Includes | |
| <complex>(C++11) | Complex number type |

### Notes

`<ccomplex>` is deprecated in C++17 and removed in C++20. Corresponding `<complex.h>` is still available in C++20.

Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/header/ccomplex&oldid=141021>"
...
- This page was last modified on 12 July 2022, at 14:23.