...
| template< class CharT, class Traits >  std::basic_ostream<CharT, Traits>&      operator<<( std::basic_ostream<CharT, Traits>& os, const std::chrono::month_day_last& mdl ); |  | (since C++20) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month_day_last/operator_ltlt&oldid=161614>"
...
- This page was last modified on 28 October 2023, at 09:37.