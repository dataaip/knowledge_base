...
|  |  |  |
| --- | --- | --- |
| const std::chrono::time_zone\* locate_zone( std::string_view tz_name ) const; |  | (since C++20) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/tzdb/locate_zone&oldid=154393>"
...
- This page was last modified on 29 June 2023, at 12:52.