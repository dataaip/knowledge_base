...
| constexpr std::chrono::year operator++( int ) noexcept; | (2) | (since C++20) |
| constexpr std::chrono::year& operator--() noexcept; | (3) | (since C++20) |
| constexpr std::chrono::year operator--( int ) noexcept; | (4) | (since C++20) |
|  |  |  |

Adds or subtracts 1 from the year value.

1,2) Performs \*this += std::chrono::years{1};.3,4) Performs \*this -= std::chrono::years{1};.
...
1,3) A reference to this `year` after modification.2,4) A copy of the `year` made before modification.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/year/operator_inc_dec&oldid=157536>"
...
- This page was last modified on 29 August 2023, at 15:19.