...
| --- | --- | --- |
| Defined in header `<execution>` |  |  |
| template< class T >  constexpr bool is_execution_policy_v = std::is_execution_policy<T>::value; |  | (since C++17) |
|  |  |  |
...
- This page was last modified on 24 September 2024, at 08:26.