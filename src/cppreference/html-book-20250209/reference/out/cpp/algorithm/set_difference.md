...
| template< class InputIt1, class InputIt2, class OutputIt >  OutputIt set_difference( InputIt1 first1, InputIt1 last1,                           InputIt2 first2, InputIt2 last2,                          OutputIt d_first ); | (1) | (constexpr since C++20) |
...
| template< class InputIt1, class InputIt2,  class OutputIt, class Compare >  OutputIt set_difference( InputIt1 first1, InputIt1 last1,                           InputIt2 first2, InputIt2 last2,                          OutputIt d_first, Compare comp ); | (3) | (constexpr since C++20) |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/set_difference&oldid=170685>"
...
- This page was last modified on 7 April 2024, at 00:00.