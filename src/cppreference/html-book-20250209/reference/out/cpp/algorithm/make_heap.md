...
1) The constructed heap is with respect to operator<(until C++20)[std::less{}(since C++20).2) The constructed heap is with respect to comp.
...
1) At most \(\scriptsize 3N\)3N comparisons using operator<(until C++20)std::less{}(since C++20).2) At most \(\scriptsize 3N\)3N applications of the comparison function comp.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/make_heap&oldid=170715>"
...
- This page was last modified on 8 April 2024, at 18:24.