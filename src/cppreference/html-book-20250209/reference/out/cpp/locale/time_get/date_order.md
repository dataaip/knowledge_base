...
1) Public member function, calls the protected virtual member function `do_date_order` of the most derived class.2) Returns a value of type std::time_base::dateorder, which describes the default date format used by this locale (expected by get_date() and produced by std::strftime() with format specifier '%x').
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/locale/time_get/date_order&oldid=160526>"
...
- This page was last modified on 11 October 2023, at 08:59.