...
|  |
| --- |
| ```text template<class CharT> bool isprint(CharT ch, const std::locale& loc) {     return std::use_facet<std::ctype<CharT>>(loc).is(std::ctype_base::print, ch); } ``` |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/locale/isprint&oldid=160083>"
...
- This page was last modified on 3 October 2023, at 10:30.