...
|  |
| --- |
| ```text template<class CharT> CharT tolower(CharT ch, const std::locale& loc) {     return std::use_facet<std::ctype<CharT>>(loc).tolower(ch); } ``` |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/locale/tolower&oldid=160219>"
...
- This page was last modified on 6 October 2023, at 10:33.