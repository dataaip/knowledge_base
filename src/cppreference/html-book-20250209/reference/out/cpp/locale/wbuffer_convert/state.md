...
|  |  |
| --- | --- |
| state | returns the current conversion state   (public member function of `std::wstring_convert<Codecvt,Elem,Wide_alloc,Byte_alloc>`) |
| mbsinit | checks if the std::mbstate_t object represents initial shift state   (function) |

Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/locale/wbuffer_convert/state&oldid=177236>"
...
- This page was last modified on 22 October 2024, at 12:04.