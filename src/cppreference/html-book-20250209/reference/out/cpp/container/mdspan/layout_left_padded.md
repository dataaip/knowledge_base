...
| template< std::size_t PaddingValue = std::dynamic_extent >  struct layout_left_padded; |  | (since C++26) |
|  |  |  |
...
|  |  |
| --- | --- |
| mapping") | a layout mapping of layout_left_padded (public member class template) |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/layout_left_padded&oldid=178057>"
...
- This page was last modified on 27 November 2024, at 01:25.