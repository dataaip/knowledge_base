...
| template< class Iter1, class Iter2 >  auto operator-( const move_iterator<Iter1>& lhs,                  const move_iterator<Iter2>& rhs ) -> decltype(lhs.base() - rhs.base()); |  | (since C++11)  (constexpr since C++17) |
|  |  |  |
