...
| template< std::input_iterator I >      requires /\* see below \*/  struct iterator_traits<std::counted_iterator<I>> : std::iterator_traits<I> {      using pointer = std::conditional_t<std::contiguous_iterator<I>,                                         std::add_pointer_t<std::iter_reference_t<I>>,                                         void>; }; |  | (since C++20) |
|  |  |  |
...
| --- | --- | --- | --- |
| P2259R1 | C++20 | there's no requires-clause `pointer` is unconditionally defined as `void` | constraint added |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/counted_iterator/iterator_traits&oldid=159834>"
...
- This page was last modified on 29 September 2023, at 23:11.