...
|  |  |  |
| --- | --- | --- |
| template< std::indirectly_swappable<I> I2 >  friend constexpr void          iter_swap( const counted_iterator& x, const std::counted_iterator<I2>& y ) noexcept(noexcept(ranges::iter_swap(x.base(), y.base()))); |  | (since C++20) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/counted_iterator/iter_swap&oldid=159833>"
...
- This page was last modified on 29 September 2023, at 23:04.