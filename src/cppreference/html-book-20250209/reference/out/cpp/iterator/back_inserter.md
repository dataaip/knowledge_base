...
| template< class Container >  std::back_insert_iterator<Container> back_inserter( Container& c ); |  | (constexpr since C++20) |
|  |  |  |
...
|  |
| --- |
| ```text template<class Container> std::back_insert_iterator<Container> back_inserter(Container& c) {     return std::back_insert_iterator<Container>(c); } ``` |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/back_inserter&oldid=167057>"
...
- This page was last modified on 24 December 2023, at 20:09.