...
1) Calls std::allocator_traits<OuterAlloc>::allocate(outer_allocator(), n).2) Additionally provides memory locality hint, by calling std::allocator_traits<OuterAlloc>::allocate(outer_allocator(), n, hint).
...
|  |  |
| --- | --- |
| allocate | allocates uninitialized storage   (public member function of `std::allocator<T>`) |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/memory/scoped_allocator_adaptor/allocate&oldid=173023>"
...
- This page was last modified on 1 July 2024, at 02:50.