...
|  |  |  |
| --- | --- | --- |
| virtual void do_deallocate( void\* p, std::size_t bytes, std::size_t alignment ) = 0; |  | (since C++17) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/memory/memory_resource/do_deallocate&oldid=153336>"
...
- This page was last modified on 14 June 2023, at 01:48.