...
1) Default constructor.2) Copy constructor. If \*this and other both have dynamic type `std::bad_weak_ptr` then std::strcmp(what(), other.what()) == 0.
...
- This page was last modified on 12 June 2023, at 10:55.