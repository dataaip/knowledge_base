...
|  |  |  |
| --- | --- | --- |
| void reset( T\* p = 0 ) throw(); |  | (deprecated in C++11)  (removed in C++17) |
|  |  |  |
...
|  |  |
| --- | --- |
| release | releases ownership of the managed object   (public member function) |

Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/memory/auto_ptr/reset&oldid=154310>"
...
- This page was last modified on 29 June 2023, at 02:36.