...
|  |  |  |
| --- | --- | --- |
| template< class Y >   bool owner_equal( const std::shared_ptr<Y>& other ) const noexcept; | (1) | (since C++26) |
| template< class Y >  bool owner_equal( const std::weak_ptr<Y>& other ) const noexcept; | (2) | (since C++26) |
|  |  |  |
