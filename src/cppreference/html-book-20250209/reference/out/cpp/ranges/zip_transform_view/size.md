...
|  |  |  |
| --- | --- | --- |
| constexpr auto size()      requires ranges::sized_range</\*InnerView\*/>; | (1) | (since C++23) |
| constexpr auto size() const      requires ranges::sized_range<const /\*InnerView\*/> | (2) | (since C++23) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/zip_transform_view/size&oldid=161252>"
...
- This page was last modified on 23 October 2023, at 14:48.