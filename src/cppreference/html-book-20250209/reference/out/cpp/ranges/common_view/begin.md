...
|  |  |  |
| --- | --- | --- |
| constexpr auto begin() requires (!__simple_view<V>); | (1) | (since C++20) |
...
Here `base_` (the name is for exposition only purposes) is the underlying view.2) Same as (1), but `V` is const-qualified.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/common_view/begin&oldid=170781>"
...
- This page was last modified on 11 April 2024, at 08:29.