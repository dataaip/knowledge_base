...
1) Equivalent to
/\*tuple-for-each\*/([](auto& i) { ++i; }, current_); return \*this;2) Equivalent to ++\*this;3) Equivalent to auto tmp = \*this; ++\*this; return tmp;4) Equivalent to
/\*tuple-for-each\*/([](auto& i) { --i; }, current_); return \*this;5) Equivalent to auto tmp = \*this; --\*this; return tmp;6) Equivalent to
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/zip_view/iterator/operator_arith&oldid=172887>"
...
- This page was last modified on 26 June 2024, at 18:42.