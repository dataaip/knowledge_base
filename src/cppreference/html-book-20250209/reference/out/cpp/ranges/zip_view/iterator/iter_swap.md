...
|  |  |  |
| --- | --- | --- |
| friend constexpr void iter_swap( const /\*iterator\*/& x, const /\*iterator\*/& y )  noexcept(/\* see below \*/)          requires (std::indirectly_swappable<ranges::iterator_t< /\*maybe-const\*/<Const, Views>>> && ...); |  | (since C++23) |
|  |  |  |
...
    declval<const ranges::iterator_t</\*maybe-const\*/<Const, Views>>&>())) &&...))
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/zip_view/iterator/iter_swap&oldid=172682>"
...
- This page was last modified on 20 June 2024, at 21:42.