...
1) Equivalent to return /\*iterator\*/<false>(ranges::begin(base_), ranges::end(base_));.2) Equivalent to return /\*iterator\*/<true>(ranges::begin(base_), ranges::end(base_));.
...
- This page was last modified on 16 August 2023, at 11:29.