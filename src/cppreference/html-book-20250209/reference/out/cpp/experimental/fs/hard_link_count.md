...
| std::uintmax_t hard_link_count( const path& p );  std::uintmax_t hard_link_count( const path& p, error_code& ec ); | (1) | (filesystem TS) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/fs/hard_link_count&oldid=154849>"
...
- This page was last modified on 15 July 2023, at 01:45.