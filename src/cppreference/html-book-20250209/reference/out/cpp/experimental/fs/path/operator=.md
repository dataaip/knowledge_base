...
1) Replaces the contents of \*this with a copy of the contents of p.2) Replaces the contents of \*this with p, possibly using move semantics: p is left in valid, but unspecified state.3) Replaces the contents of \*this with a new path value constructed from source as if by overload (4) of the path constructor. Equivalent to assign(source).
...
1) (none)2)noexcept specification:noexcept3) (none)
...
- This page was last modified on 10 February 2024, at 06:01.