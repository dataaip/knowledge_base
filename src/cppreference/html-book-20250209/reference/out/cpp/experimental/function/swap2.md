...
|  |  |  |
| --- | --- | --- |
| template< class R, class... Args >  void swap( std::experimental::function<R(Args...)> &lhs, std::experimental::function<R(Args...)> &rhs ); |  |  |
|  |  |  |
...
- This page was last modified on 16 July 2023, at 23:26.