...
1) The default constructor initializes the object to an empty state.2) Initializes the underlying `weak_ptr<T>` with `desired`. The initialization is not atomic.3) Atomic variables are not CopyConstructible.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/atomic_weak_ptr/atomic_weak_ptr&oldid=103077>"
...
- This page was last modified on 15 June 2018, at 14:13.