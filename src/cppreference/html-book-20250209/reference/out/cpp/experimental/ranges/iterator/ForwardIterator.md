...
| template< class I >  concept bool ForwardIterator =      InputIterator<I> &&      DerivedFrom<ranges::iterator_category_t<I>, ranges::forward_iterator_tag> &&      Incrementable<I> &&     Sentinel<I, I>; |  | (ranges TS) |
|  |  |  |
...
- a == b implies ++a == ++b; and
- The expression ([{ ++x; }(a), \*a) is equivalent to \*a, i.e., incrementing a copy of `a` has no effect on the result of dereferencing `a`.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/ranges/iterator/ForwardIterator&oldid=155450>"
...
- This page was last modified on 25 July 2023, at 23:07.