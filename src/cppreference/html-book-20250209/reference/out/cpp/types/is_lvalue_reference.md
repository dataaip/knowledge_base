...
|  |  |  |
| --- | --- | --- |
| template< class T >  constexpr bool is_lvalue_reference_v = is_lvalue_reference<T>::value; |  | (since C++17) |
|  |  |  |
...
|  |  |
| --- | --- |
| value[static] | true if `T` is an lvalue reference type, false otherwise   (public static member constant) |
...
|  |
| --- |
| ```text template<class T> struct is_lvalue_reference     : std::false_type {}; template<class T> struct is_lvalue_reference<T&> : std::true_type {}; ``` |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_lvalue_reference&oldid=176469>"
...
- This page was last modified on 24 September 2024, at 12:47.