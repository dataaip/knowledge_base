...
|  |  |
| --- | --- |
| value[static] | true if `T` is an array type of known bound, false otherwise   (public static member constant) |
...
|  |
| --- |
| ```text template<class T> struct is_bounded_array : std::false_type {};   template<class T, std::size_t N> struct is_bounded_array<T[N]> : std::true_type {}; ``` |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_bounded_array&oldid=158874>"
...
- This page was last modified on 12 September 2023, at 06:33.