...
|  |  |
| --- | --- |
| value[static] | true if `T` is the type void (possibly cv-qualified), false otherwise   (public static member constant) |
...
|  |
| --- |
| ```text template<class T> struct is_void : std::is_same<void, typename std::remove_cv<T>::type> {}; ``` |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_void&oldid=176462>"
...
- This page was last modified on 24 September 2024, at 12:21.