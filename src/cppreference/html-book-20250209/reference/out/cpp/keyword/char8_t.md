...
| `202207L` | (C++20) (DR) | char8_t compatibility and portability fix (allow initialization of (`unsigned`) `char` arrays from UTF-8 string literals) |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/char8_t&oldid=175637>"
...
- This page was last modified on 1 September 2024, at 06:53.