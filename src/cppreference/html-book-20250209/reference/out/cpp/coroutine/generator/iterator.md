...
1) Let for some generator object x the `coroutine_` be in the stack \*x.active_. Equivalent to x.active_->top().resume(). Returns: \*this.2) Equivalent to ++\*this;.

### Non-member functions

|  |  |
| --- | --- |
| operator==(C++23) | compares the underlying iterator with a sentinel   (function) |
...
- This page was last modified on 9 December 2024, at 17:52.