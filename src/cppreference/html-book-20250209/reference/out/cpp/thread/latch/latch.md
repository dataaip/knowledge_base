...
1) Constructs a `latch` and initializes its internal counter. The behavior is undefined if expected is negative or greater than max().2) Copy constructor is deleted. `latch` is neither copyable nor movable.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/thread/latch/latch&oldid=161155>"
...
- This page was last modified on 22 October 2023, at 10:44.