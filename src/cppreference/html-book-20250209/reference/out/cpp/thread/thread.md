...
The class `thread` represents a single thread of execution "enwiki:Thread (computing)"). Threads allow multiple functions to execute concurrently.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/thread/thread&oldid=161278>"
...
- This page was last modified on 24 October 2023, at 01:41.