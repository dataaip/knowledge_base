...
1-3) Atomically stores value into the shared state and makes the state ready.4) Makes the state ready.
...
1) Any exception thrown by the constructor selected to copy an object of type `R`.2) Any exception thrown by the constructor selected to move an object of type `R`.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/thread/promise/set_value&oldid=169933>"
...
- This page was last modified on 25 February 2024, at 21:52.