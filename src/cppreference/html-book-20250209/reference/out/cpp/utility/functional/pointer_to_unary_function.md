...
|  |  |  |
| --- | --- | --- |
| template<   class Arg,       class Result > class pointer_to_unary_function : public std::unary_function<Arg, Result>; |  | (deprecated in C++11)  (removed in C++17) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/pointer_to_unary_function&oldid=156673>"
...
- This page was last modified on 14 August 2023, at 09:19.