...
| std::formatter<std::pair>(C++23) | formatting support for `pair`   (class template specialization) |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/utility/pair&oldid=173867>"
