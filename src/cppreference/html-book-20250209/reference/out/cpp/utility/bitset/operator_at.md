...
1) The value of the requested bit.2) An object of type std::bitset::reference, which allows writing to the requested bit.
...
| LWG 907 | C++98 | the behavior of reading the bit at pos was equivalent to that of `test(pos)`, but `test()` may throw exceptions | avoids mentioning `test()` |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/utility/bitset/operator_at&oldid=161321>"
...
- This page was last modified on 24 October 2023, at 21:41.