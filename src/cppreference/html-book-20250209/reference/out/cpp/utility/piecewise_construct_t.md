...
1) `std::piecewise_construct_t` is an empty class tag type used to disambiguate between different functions that take two tuple arguments.2) The constant `std::piecewise_construct` is an instance of (1).
...
- This page was last modified on 18 July 2024, at 03:04.