...
|  |  |  |
| --- | --- | --- |
| friend bool operator==( const gamma_distribution& lhs,                          const gamma_distribution& rhs ); | (1) | (since C++11) |
| friend bool operator!=( const gamma_distribution& lhs,                          const gamma_distribution& rhs ); | (2) | (since C++11)  (until C++20) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/gamma_distribution/operator_cmp&oldid=135768>"
