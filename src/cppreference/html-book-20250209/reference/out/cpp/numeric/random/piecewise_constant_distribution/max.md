# std::piecewise_constant_distribution<RealType>::max
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/piecewise_constant_distribution/max&oldid=135800>"
