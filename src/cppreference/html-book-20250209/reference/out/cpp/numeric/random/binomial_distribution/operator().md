# std::binomial_distribution<IntType>::operator()
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/binomial_distribution/operator()&oldid=132202>"
