...
|  |  |  |
| --- | --- | --- |
| friend bool operator==( const fisher_f_distribution& lhs,                          const fisher_f_distribution& rhs ); | (1) | (since C++11) |
| friend bool operator!=( const fisher_f_distribution& lhs,                          const fisher_f_distribution& rhs ); | (2) | (since C++11)  (until C++20) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/fisher_f_distribution/operator_cmp&oldid=135814>"
