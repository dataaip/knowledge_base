...
| --- | --- | --- |
|  | (1) |  |
| float       acosh ( float num );  double      acosh ( double num ); long double acosh ( long double num ); |  | (until C++23) |
...
| long double acoshl( long double num ); | (3) | (since C++11)  (constexpr since C++26) |
| SIMD overload (since C++26) |  |  |
| Defined in header `<simd>` |  |  |
| template< /\*math-floating-point\*/ V >  constexpr /\*deduced-simd-t\*/<V>             acosh ( const V& v_num ); | (S) | (since C++26) |
...
|  |  |
| --- | --- |
| S) The SIMD overload performs an element-wise `std::acosh` on v_num. (See **math-floating-point** and **deduced-simd-t** for their definitions.) | (since C++26) |
...
- This page was last modified on 20 December 2024, at 13:15.