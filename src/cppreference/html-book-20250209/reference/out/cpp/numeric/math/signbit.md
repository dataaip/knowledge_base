...
|  |  |
| --- | --- |
| S) The SIMD overload performs an element-wise `std::signbit` on v_num. (See **math-floating-point** and **deduced-simd-t** for their definitions.) | (since C++26) |
...
1) true if num is negative, false otherwise.S) A data-parallel mask object where the ith element equals true if v_num[i] is negative or false otherwise for all i in the range ``​0​`,`v_num.size()`)`.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/signbit&oldid=149497>"
...
- This page was last modified on 21 March 2023, at 14:46.