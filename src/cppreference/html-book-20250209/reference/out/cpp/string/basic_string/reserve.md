...
| - If new_cap is less than or equal to the current capacity(), there is no effect. | (since C++20) |
 ...
 If a capacity change takes place, all iterators and references, including the past-the-end iterator, are invalidated.2) A non-binding shrink-to-fit request. After this call, capacity() has an unspecified value greater than or equal to size().
...
- This page was last modified on 21 April 2024, at 14:23.