...
| template< class T >  struct is_enum; |  | (since C++11) |
|  |  |  |
...
|  |  |  |
| --- | --- | --- |
| template< class T >  constexpr bool is_enum_v = is_enum<T>::value; |  | (since C++17) |
|  |  |  |
...
|  |  |
| --- | --- |
| value[static] | true if `T` is an enumeration type, false otherwise   (public static member constant) |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_enum&oldid=157383>"
...
- This page was last modified on 26 August 2023, at 09:54.