...
|  |
| --- |
| ```text template<class T> struct remove_cvref {     using type = std::remove_cv_t<std::remove_reference_t<T>>; }; ``` |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/types/remove_cvref&oldid=170266>"
...
- This page was last modified on 23 March 2024, at 00:35.