...
|  |  |  |
| --- | --- | --- |
| double      expint( double arg );  double      expint( float arg );  double      expint( long double arg );  float       expintf( float arg ); long double expintl( long double arg ); | (1) |  |
| double      expint( IntegralType arg ); | (2) |  |
|  |  |  |

1) Computes the exponential integral of arg.2) A set of overloads or a function template accepting an argument of any integral type. Equivalent to (1) after casting the argument to double.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/special_functions/expint&oldid=158798>"
...
- This page was last modified on 11 September 2023, at 10:40.