...
| CWG 1929 | C++98 | it was not clear whether the template disambiguator can follow a `::` where the name to its left refers to a namespace | allowed |
...
| CWG 2905 | C++11 | a noexcept expression was only value-dependent if its operand is value-dependent | it is value-dependent if its operand involves a template parameter |
| CWG 2936 | C++98 | the names of local classes of templated functions were not part of the current instantiation | they are |

Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/language/dependent_name&oldid=180200>"
