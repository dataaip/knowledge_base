...
|  |  |
| --- | --- |
| A `(` token that follows explicit is always parsed as part of the explicit specifier:   ```text struct S {     explicit (S)(const S&);    // error in C++20, OK in C++17     explicit (operator int)(); // error in C++20, OK in C++17 }; ``` | (since C++20) |
...
- This page was last modified on 11 August 2024, at 23:29.