...
|  |  |  |
| --- | --- | --- |
| void wait( value_type old, std::memory_order order =                                 std::memory_order_seq_cst ) const noexcept; |  | (constexpr since C++26) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_ref/wait&oldid=116003>"
...
- This page was last modified on 8 February 2020, at 07:06.