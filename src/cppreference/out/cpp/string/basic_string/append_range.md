...
|  |  |  |
| --- | --- | --- |
| template< container-compatible-range<CharT> R >  constexpr std::basic_string& append_range( R&& rg ); |  | (since C++23) |
|  |  |  |
...
- This page was last modified on 28 October 2023, at 14:47.