...
| max_size | returns the maximum number of characters   (public member function of `std::basic_string<CharT,Traits,Allocator>`) |
...
- This page was last modified on 27 December 2023, at 16:12.