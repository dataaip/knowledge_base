...
|  |  |
| --- | --- |
| is_error_code_enum<std::future_errc>(C++11) | extends the type trait std::is_error_code_enum to identify future error codes   (class template) |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/thread/future_errc&oldid=173773>"
...
- This page was last modified on 18 July 2024, at 03:15.