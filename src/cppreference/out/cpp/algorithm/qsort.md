...
| void qsort( void \*ptr, std::size_t count,  std::size_t size, /\* c-compare-pred \*/\* comp );  void qsort( void \*ptr, std::size_t count, std::size_t size, /\* compare-pred \*/\* comp ); | (1) |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/qsort&oldid=158954>"
...
- This page was last modified on 13 September 2023, at 00:13.