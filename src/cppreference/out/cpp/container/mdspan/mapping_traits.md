...
1-3) Let `func` be (1) `is_unique`, (2) `is_exhaustive`, or (3) `is_strided`, then it's equivalent to return map_.func();.4-6) Let `func` be (4) `is_always_unique`, (5) `is_always_exhaustive`, or (6) `is_always_strided`, then it's equivalent to return mapping_type::func();.
...
- This page was last modified on 23 December 2024, at 16:23.