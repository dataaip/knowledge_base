...
| template< std::size_t PaddingValue = std::dynamic_extent >  struct layout_right_padded; |  | (since C++26) |
|  |  |  |
...
|  |  |
| --- | --- |
| mapping") | a layout mapping of layout_right_padded (public member class template) |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/layout_right_padded&oldid=178334>"
...
- This page was last modified on 11 December 2024, at 11:24.