...
| --- | --- | --- |
|  | (2) |  |
| unordered_set& operator=( unordered_set&& other ); |  | (since C++11)  (until C++17) |
| unordered_set& operator=( unordered_set&& other ) noexcept(/\* see below \*/); |  | (since C++17) |
|  |  |  |
| --- | --- | --- |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/container/unordered_set/operator%3D&oldid=125823>"
...
- This page was last modified on 12 January 2021, at 05:09.