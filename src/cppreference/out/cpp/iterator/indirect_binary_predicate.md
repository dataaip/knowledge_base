...
| P2997R1 | C++20 | `indirect_binary_predicate` required F& to satisfy `predicate` with std::iter_common_reference_t<I> | does not require |
...
- This page was last modified on 23 August 2024, at 18:04.