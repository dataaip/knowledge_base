...
|  |  |  |
| --- | --- | --- |
| template< std::indirectly_swappable<Iter> Iter2 >  friend constexpr void iter_swap( const reverse_iterator& x,                                   const std::reverse_iterator<Iter2>& y ) noexcept(/\* see below \*/); |  | (since C++20) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/reverse_iterator/iter_swap&oldid=177530>"
...
- This page was last modified on 4 November 2024, at 22:29.