...
| template< class Iter >  std::reverse_iterator<Iter> make_reverse_iterator( Iter i ); |  | (since C++14)  (constexpr since C++17) |
|  |  |  |
...
- This page was last modified on 4 November 2024, at 22:33.