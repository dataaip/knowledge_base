...
|  |  |  |
| --- | --- | --- |
| constexpr std::iter_const_reference_t<Iter> operator[]( difference_type n ) const      requires std::random_access_iterator<Iterator>; |  | (since C++23) |
|  |  |  |
...
- This page was last modified on 20 April 2024, at 13:32.