...
| template< class In, class Out >  concept indirectly_copyable =      std::indirectly_readable<In> && std::indirectly_writable<Out, std::iter_reference_t<In>>; |  | (since C++20) |
|  |  |  |
...
- This page was last modified on 30 September 2023, at 22:13.