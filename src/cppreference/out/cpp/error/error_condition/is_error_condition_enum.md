...
| template< class T >  struct is_error_condition_enum; |  | (since C++11) |
|  |  |  |
...
|  |  |  |
| --- | --- | --- |
| template< class T >  inline constexpr bool is_error_condition_enum_v =     is_error_condition_enum<T>::value; |  | (since C++17) |
|  |  |  |
...
|  |  |
| --- | --- |
| value[static] | true if `T` is an error condition enum, false otherwise   (public static member constant) |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/error/error_condition/is_error_condition_enum&oldid=170137>"
...
- This page was last modified on 12 March 2024, at 17:27.