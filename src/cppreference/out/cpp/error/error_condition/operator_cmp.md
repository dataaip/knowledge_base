...
1) Checks whether lhs and rhs are equal.2) Checks whether lhs and rhs are not equal.3) Checks whether lhs is **less than** rhs.4) Obtains three-way comparison result of lhs and rhs.5) Checks whether code is a semantic match for cond.6) Checks whether code is not a semantic match for cond.
...
- This page was last modified on 22 August 2023, at 23:34.