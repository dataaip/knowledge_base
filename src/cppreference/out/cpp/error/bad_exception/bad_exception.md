...
1) Default constructor. `what()` returns an implementation-defined string.2) Copy constructor. Initializes the object with the contents of other. If \*this and other both have dynamic type `std::bad_exception` then std::strcmp(what(), other.what()) == 0(since C++11).
...
- This page was last modified on 24 November 2024, at 06:24.