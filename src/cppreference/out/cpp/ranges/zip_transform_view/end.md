...
| constexpr auto end() const      requires ranges::range<const /\*InnerView\*/> &&               std::regular_invocable<const F&, ranges::range_reference_t<const Views>...>; | (2) | (since C++23) |
|  |  |  |
...
return /\*sentinel\*/<false>(zip_.end());2) Equivalent to:   
...
- This page was last modified on 29 June 2022, at 13:43.