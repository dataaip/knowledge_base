...
|  |  |  |
| --- | --- | --- |
| template< bool OtherConst >      requires std::sentinel_for</\*zentinel\*/<Const>, /\*ziperator\*/<OtherConst>>  friend constexpr bool operator==( const /\*iterator\*/<OtherConst>& x, const /\*sentinel\*/& y ); |  | (since C++23) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/zip_transform_view/sentinel/operator_cmp&oldid=172614>"
...
- This page was last modified on 20 June 2024, at 19:19.