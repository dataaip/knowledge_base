...
1) Copy constructs the result from the underlying view.2) Move constructs the result from the underlying view.

### Return value

1) A copy of the underlying view.2) A view move-constructed from the underlying view.
...
|  |  |
| --- | --- |
| base | returns a copy of the underlying (adapted) view   (public member function of `std::ranges::lazy_split_view<V,Pattern>`) |
...
- This page was last modified on 28 January 2025, at 11:49.