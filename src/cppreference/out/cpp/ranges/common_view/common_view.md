...
1) Default constructor. Value-initializes the underlying view. After construction, `base()` returns a copy of V().2) Initializes the underlying view with std::move(r).
...
- This page was last modified on 18 August 2021, at 19:14.