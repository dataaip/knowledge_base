...
2) Equivalent to return x.current_ < y.current_;.3) Equivalent to return y < x;.4) Equivalent to return !(y < x);.5) Equivalent to return !(x < y);.6) Equivalent to return x.current_ <=> y.current_;.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/slide_view/iterator/operator_cmp&oldid=172663>"
...
- This page was last modified on 20 June 2024, at 21:06.