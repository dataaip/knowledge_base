...
|  |  |  |
| --- | --- | --- |
| constexpr subrange prev( std::iter_difference_t<I> n = 1 ) const      requires std::bidirectional_iterator<I>; |  | (since C++20) |
|  |  |  |
...
- This page was last modified on 28 January 2025, at 05:45.