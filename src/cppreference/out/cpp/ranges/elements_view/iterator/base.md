...
1) Returns a reference to the underlying iterator.2) Move constructs the result from the underlying iterator.
...
1) A reference to the underlying iterator.1) An iterator move constructed from the underlying iterator.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/elements_view/iterator/base&oldid=134220>"
...
- This page was last modified on 7 October 2021, at 17:34.