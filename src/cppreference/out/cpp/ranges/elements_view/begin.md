...
1) Equivalent to return /\*iterator\*/<false>(ranges::begin(base_));.2) Equivalent to return /\*iterator\*/<true>(ranges::begin(base_));.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/elements_view/begin&oldid=173588>"
...
- This page was last modified on 13 July 2024, at 11:08.