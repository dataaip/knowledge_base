...
| constexpr explicit /\*sentinel\*/( ranges::sentinel_t<Base> end ); | (2) | (since C++20) |
...
1) Default constructor. Value-initializes the underlying sentinel.2) Initializes the underlying sentinel with `end`.3) Conversion from /\*sentinel\*/<false> to /\*sentinel\*/<true>. Move constructs the underlying sentinel.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/elements_view/sentinel/sentinel&oldid=131953>"
...
- This page was last modified on 1 August 2021, at 04:07.