...
|  |  |  |
| --- | --- | --- |
| constexpr auto size()      requires (ranges::sized_range<Views> && ...); | (1) | (since C++23) |
| constexpr auto size() const      requires (ranges::sized_range<const Views> && ...); | (2) | (since C++23) |
|  |  |  |
...
- This page was last modified on 15 August 2023, at 12:17.