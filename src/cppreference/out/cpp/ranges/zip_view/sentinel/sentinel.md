...
| constexpr /\*sentinel\*/( /\*sentinel\*/<!Const> i )      requires Const &&          (std::convertible_to<              ranges::sentinel_t<Views>, ranges::sentinel_t</\*maybe-const\*/<Const, Views>>> && ...); | (2) | (since C++23) |
|  |  |  |

Constructs a sentinel.

1) Default constructor. Value-initializes the underlying tuple of sentinels `end_`.2) Conversion from /\*sentinel\*/<false> to /\*sentinel\*/<true>. Move constructs the underlying tuple of sentinels `end_` with std::move(i.end_).
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/zip_view/sentinel/sentinel&oldid=156776>"
...
- This page was last modified on 15 August 2023, at 12:28.