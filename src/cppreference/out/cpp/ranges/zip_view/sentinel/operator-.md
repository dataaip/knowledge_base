...
1) the value with the smallest absolute value among `DIST(x, y, i)` of all `i` in range `0 ≤ i < sizeof...(Views)`2) -(x - y).
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/zip_view/sentinel/operator-&oldid=172679>"
...
- This page was last modified on 20 June 2024, at 21:36.