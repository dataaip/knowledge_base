...
1) Default constructor. Value-initializes all adapted `view` objects. The default constructor is deleted if std::is_default_constructible_v is false for at least one type in `Views...`.2) Move constructs every adapted `view` object in `views_` from the corresponding view in views....
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/zip_view/zip_view&oldid=172778>"
...
- This page was last modified on 23 June 2024, at 15:12.