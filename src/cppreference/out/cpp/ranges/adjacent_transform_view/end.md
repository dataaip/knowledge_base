...
| constexpr auto end() const      requires ranges::range<const InnerView> &&          std::regular_invocable<const F&, /\*REPEAT\*/(ranges::range_reference_t<const V>, N)...>; | (2) | (since C++23) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/adjacent_transform_view/end&oldid=172656>"
...
- This page was last modified on 20 June 2024, at 20:54.