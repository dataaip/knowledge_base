...
|  |  |  |
| --- | --- | --- |
| template< bool OtherConst >      requires std::sized_sentinel_for</\*inner-sentinel\*/<Const>,                                       /\*inner-iterator\*/<OtherConst>>  friend constexpr      ranges::range_difference_t</\*maybe-const\*/<OtherConst, InnerView>>         operator-( const /\*iterator\*/<OtherConst>& x, const /\*sentinel\*/& y ); | (1) | (since C++23) |
| template< bool OtherConst >      requires std::sized_sentinel_for</\*inner-sentinel\*/<Const>,                                       /\*inner-iterator\*/<OtherConst>>  friend constexpr      ranges::range_difference_t</\*maybe-const\*/<OtherConst, InnerView>>         operator-( const /\*sentinel\*/& y, const /\*iterator\*/<OtherConst>& x ); | (2) | (since C++23) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/adjacent_transform_view/sentinel/operator-&oldid=172655>"
...
- This page was last modified on 20 June 2024, at 20:51.