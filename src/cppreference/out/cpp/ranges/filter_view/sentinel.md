...
| `end_` (private) | The sentinel of the underlying `view`. (exposition-only member object\*) |
...
1) Value-initializes `end_` via its default member initializer (= ranges::sentinel_t<V>()).2) Initializes `end_` with ranges::end(parent.base_).
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/filter_view/sentinel&oldid=172700>"
...
- This page was last modified on 20 June 2024, at 22:25.