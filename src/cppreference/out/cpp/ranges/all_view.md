...
1) A RangeAdaptorObject (also a RangeAdaptorClosureObject) that returns a `view` that includes all elements of its `range` argument. Given an expression e of type `R`, the expression views::all(e) is expression-equivalent to:
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/all_view&oldid=160897>"
...
- This page was last modified on 18 October 2023, at 10:18.