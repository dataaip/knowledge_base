...
| constexpr InnerIter operator->() const      requires /\*has-arrow\*/<InnerIter> && std::copyable<InnerIter>; | (2) | (since C++20) |
|  |  |  |

Returns the element the underlying iterator `inner_` points to.

1) Equivalent to return \*inner_;.2) Equivalent to return inner_;.
...
Retrieved from "https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/join_view/iterator/operator\*&oldid=175908"
...
- This page was last modified on 8 September 2024, at 11:48.