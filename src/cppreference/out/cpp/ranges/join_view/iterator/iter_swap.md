...
|  |  |  |
| --- | --- | --- |
| friend constexpr void iter_swap( const /\*iterator\*/& x, const /\*iterator\*/& y )  noexcept( /\*see below\*/ )         requires std::indirectly_swappable<InnerIter>; |  | (since C++20) |
|  |  |  |
...
noexcept specification:noexcept(noexcept(ranges::iter_swap(x.inner_, y.inner_)))
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/join_view/iterator/iter_swap&oldid=175913>"
...
- This page was last modified on 8 September 2024, at 11:56.