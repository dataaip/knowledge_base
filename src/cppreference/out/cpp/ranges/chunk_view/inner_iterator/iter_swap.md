...
|  |  |  |
| --- | --- | --- |
| friend constexpr void iter_swap( const /\*inner-iterator\*/& x,  const /\*inner-iterator\*/& y )      noexcept(noexcept(ranges::iter_swap(\*x.parent_->current_,                                          \*y.parent_->current_)))     requires std::indirectly_swappable<ranges::iterator_t<V>>; |  | (since C++23) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/inner_iterator/iter_swap&oldid=172667>"
...
- This page was last modified on 20 June 2024, at 21:13.