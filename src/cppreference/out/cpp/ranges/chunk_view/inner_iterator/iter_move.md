...
noexcept specification:noexcept(noexcept(ranges::iter_move(\*i.parent_->current_)))
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/inner_iterator/iter_move&oldid=172668>"
