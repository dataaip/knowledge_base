...
| private:  constexpr explicit /\*outer-iterator\*/( chunk_view& parent ); | (2) | (exposition only\*) |
|  |  |  |

Construct an iterator.

1) Move constructor. Move-initializes the underlying pointer `parent_` with other.`parent_`.2) A private constructor which is used by chunk_view::begin. This constructor is not accessible to users. Initializes `parent_` with std::addressof(parent).
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/outer_iterator/outer_iterator&oldid=156080>"
...
- This page was last modified on 1 August 2023, at 22:56.