...
1) Default constructor.2) Copy constructor. If \*this and other both have dynamic type `std::bad_optional_access` then std::strcmp(what(), other.what()) == 0.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/utility/optional/bad_optional_access&oldid=124132>"
...
- This page was last modified on 15 November 2020, at 06:30.