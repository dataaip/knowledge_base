...
1) Forms lvalue reference to const type of t.2) const rvalue reference overload is deleted to disallow rvalue arguments.

### Possible implementation

|  |
| --- |
| ```text template<class T> constexpr std::add_const_t<T>& as_const(T& t) noexcept {     return t; } ``` |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/utility/as_const&oldid=151976>"
...
- This page was last modified on 21 May 2023, at 09:00.