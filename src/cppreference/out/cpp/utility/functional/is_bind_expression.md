...
| --- | --- | --- | --- |
| LWG 2010 | C++11 | program-defined specializations could only be derived from std::false_type | can be derived from std::true_type |
...
- This page was last modified on 24 September 2024, at 09:08.