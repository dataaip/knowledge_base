...
|  |  |
| --- | --- |
| operator bool | checks if the `std::move_only_function` has a target   (public member function of `std::move_only_function`) |

|  |
| --- |
|  |

Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/function/operator_bool&oldid=161377>"
...
- This page was last modified on 25 October 2023, at 10:23.