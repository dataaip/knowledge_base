...
| --- | --- | --- | --- |
| CWG 273 | C++98 | it was unclear whether `va_start` is required to support parm_ns with overloaded `operator&` | required |
| LWG 2099 | C++98 | the behavior was undefined if parm_n is declared with a function, array, or reference type | the behavior is undefined if parm_n is of reference type |
...
- This page was last modified on 25 February 2024, at 22:10.