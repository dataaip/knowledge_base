...
1) Default constructor. Creates an empty `stacktrace_entry`.2) Copy constructor. Creates a copy of `other`.
...
|  |  |
| --- | --- |
| (constructor) | constructs a new `source_location` with implementation-defined values   (public member function of `std::source_location`) |
...
- This page was last modified on 23 January 2021, at 10:07.