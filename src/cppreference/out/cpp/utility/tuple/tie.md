...
|  |
| --- |
| ```text template <typename... Args> constexpr // since C++14 std::tuple<Args&...> tie(Args&... args) noexcept {     return {args...}; } ``` |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/utility/tuple/tie&oldid=178881>"
...
- This page was last modified on 30 December 2024, at 07:02.