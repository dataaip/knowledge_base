...
| template< tuple-like TTuple, tuple-like UTuple,  template<class> class TQual, template<class> class UQual >      requires /\* see below \*/ struct basic_common_reference<TTuple, UTuple, TQual, UQual>; |  | (since C++23) |
|  |  |  |
...
- This page was last modified on 12 June 2023, at 15:57.