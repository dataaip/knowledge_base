...
| template< class T >  constexpr int popcount( T x ) noexcept; |  | (since C++20) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/popcount&oldid=178991>"
