...
1) Returns the a distribution parameter (location). The default value is 1.0.2) Returns the b distribution parameter (scale). The default value is 0.0.
...
1) The a distribution parameter (location).2) The b distribution parameter (scale).
...
- This page was last modified on 28 November 2021, at 15:52.