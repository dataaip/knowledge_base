...
1) Returns the α distribution parameter. It is also known as the shape parameter. The default value is 1.0.2) Returns the β distribution parameter. It is also known as the scale parameter. The default value is 1.0.
...
1) Floating point value identifying the α parameter.2) Floating point value identifying the β parameter.
...
- This page was last modified on 1 May 2023, at 23:43.