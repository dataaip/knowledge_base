...
| Characteristics | | | | |
| negative_binomial_distribution::pnegative_binomial_distribution::k | | | | |
...
|  |  |  |
| --- | --- | --- |
| template< class CharT, class Traits >  friend std::basic_ostream<CharT,Traits>&      operator<<( std::basic_ostream<CharT,Traits>& ost, const negative_binomial_distribution& d ); | (1) | (since C++11) |
| template< class CharT, class Traits >  friend std::basic_istream<CharT,Traits>&      operator>>( std::basic_istream<CharT,Traits>& ist,                 negative_binomial_distribution& d ); | (2) | (since C++11) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/negative_binomial_distribution/operator_ltltgtgt&oldid=132429>"
...
- This page was last modified on 14 August 2021, at 15:09.