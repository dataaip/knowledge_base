...
1) Returns the pointer to the underlying byte stream.2) Replaces the associated byte stream with bytebuf.

### Return value

1) `bufptr`2) the previous value of `bufptr`
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/locale/wbuffer_convert/rdbuf&oldid=177240>"
...
- This page was last modified on 22 October 2024, at 17:28.