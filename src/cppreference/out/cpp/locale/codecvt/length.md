...
| LWG 305 | C++98 | `std::codecvt<wchar_t, char, std::mbstate_t>::do_length` was required to return std::min(max, from_end - from) | not required |
...
- This page was last modified on 6 October 2024, at 05:25.