...
1) true if other is a copy of \*this or has an identical name, false otherwise.2) false if other is a copy of \*this or has an identical name, true otherwise.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/locale/locale/operator_cmp&oldid=177155>"
