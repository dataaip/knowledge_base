...
|  |
| --- |
| ```text template<class CharT> bool isupper(CharT ch, const std::locale& loc) {     return std::use_facet<std::ctype<CharT>>(loc).is(std::ctype_base::upper, ch); } ``` |
...
- This page was last modified on 4 October 2023, at 06:14.