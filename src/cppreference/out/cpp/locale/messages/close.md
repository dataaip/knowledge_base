...
1) Public member function, calls the protected virtual member function `do_close` of the most derived class.2) Releases the implementation-defined resources associated with an open catalog that is designated by the value c of type `catalog` (inherited from std::messages_base), which was obtained from open().
...
- This page was last modified on 13 September 2023, at 22:44.