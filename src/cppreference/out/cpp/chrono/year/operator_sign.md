...
1) Returns a copy of \*this.2) Returns a `year` whose year value is the negation of that of \*this.

### Return value

1) \*this2) std::chrono::year(-int(\*this))
...
- This page was last modified on 29 August 2023, at 10:30.