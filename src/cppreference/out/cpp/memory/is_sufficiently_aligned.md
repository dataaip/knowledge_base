...
|  |
| --- |
| ```text template<std::size_t N, class T> bool is_sufficiently_aligned(T* ptr) {     return std::bit_cast<std::uintptr_t>(ptr) % N == 0; } ``` |
...
- This page was last modified on 31 December 2024, at 05:26.