...
1) Calls ::new((void\*)p) T(val).2) Calls ::new((void\*)p) U(std::forward<Args>(args)...).
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/memory/allocator/construct&oldid=147546>"
...
- This page was last modified on 7 February 2023, at 00:07.