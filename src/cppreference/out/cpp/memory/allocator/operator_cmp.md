...
| template< class T1, class T2 >  constexpr bool     operator==( const allocator<T1>& lhs, const allocator<T2>& rhs ) noexcept; |  | (since C++20) |
|  |  |  |
| --- | --- | --- |
|  | (2) |  |
| template< class T1, class T2 >  bool operator!=( const allocator<T1>& lhs, const allocator<T2>& rhs ) throw(); |  | (until C++11) |
...
1) Returns true.2) Returns false.
...
- This page was last modified on 11 June 2023, at 10:12.