...
|  |  |  |
| --- | --- | --- |
| memory_resource() = default; | (1) | (since C++17)  (implicitly declared) |
| memory_resource( const memory_resource& ) = default; | (2) | (since C++17)  (implicitly declared) |
|  |  |  |

1) Implicitly declared default constructor.2) Implicitly declared copy constructor.
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/memory/memory_resource/memory_resource&oldid=133567>"
...
- This page was last modified on 13 September 2021, at 04:38.