...
| template< class T >  shared_ptr( std::weak_ptr<T> ) -> shared_ptr<T>; | (1) | (since C++17) |
| template< class T, class D >  shared_ptr( std::unique_ptr<T, D> ) -> shared_ptr<T>; | (2) | (since C++17) |
|  |  |  |
...
- This page was last modified on 16 February 2023, at 15:09.