...
|  |  |  |
| --- | --- | --- |
| T& operator\*() const throw(); | (1) | (deprecated in C++11)  (removed in C++17) |
| T\* operator->() const throw(); | (2) | (deprecated in C++11)  (removed in C++17) |
|  |  |  |
...
- This page was last modified on 29 June 2023, at 02:32.