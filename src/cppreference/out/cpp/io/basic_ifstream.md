...
| (destructor)[virtual] (implicitly declared) | destructs the `basic_ifstream` and the associated buffer, closes the file   (virtual public member function) |
...
- This page was last modified on 7 September 2023, at 23:06.