...
- `if` statement: begins the `if` statement

|  |  |
| --- | --- |
| - `constexpr` `if` statement: begins the `constexpr` `if` statement | (since C++17) |
| - `consteval` `if` statement: begins the `consteval` `if` statement | (since C++23) |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/if&oldid=176222>"
...
- This page was last modified on 16 September 2024, at 05:05.