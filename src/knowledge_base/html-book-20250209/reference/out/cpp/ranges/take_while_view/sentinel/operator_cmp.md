...
|  |  |  |
| --- | --- | --- |
| friend constexpr bool operator==( const ranges::iterator_t<Base>& x,                                    const /\*sentinel\*/& y ); |  | (since C++20) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/take_while_view/sentinel/operator_cmp&oldid=172691>"
...
- This page was last modified on 20 June 2024, at 22:04.