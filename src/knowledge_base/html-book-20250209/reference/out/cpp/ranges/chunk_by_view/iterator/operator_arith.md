...
```
 ...
 The behavior is undefined if before the call to this operator `current_` is equal to `next_`.2) Equivalent to: auto tmp = \*this; ++\*this; return tmp;3) Equivalent to:
...
1,3) \*this2,4) a copy of \*this that was made before the change.
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_by_view/iterator/operator_arith&oldid=151081>"
...
- This page was last modified on 27 April 2023, at 08:44.