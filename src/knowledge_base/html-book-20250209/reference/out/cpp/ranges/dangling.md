...
1) `dangling` is trivially default constructible.2) `dangling` can be constructed from arguments of arbitrary number and arbitrary non-void type. The construction does not have any side-effect itself.
...
- This page was last modified on 18 September 2021, at 17:20.