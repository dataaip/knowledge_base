...
| constexpr auto begin() const      requires ranges::forward_range<V> && ranges::forward_range<const V>; | (2) | (since C++20) |
|  |  |  |
...
- This page was last modified on 28 January 2025, at 14:37.