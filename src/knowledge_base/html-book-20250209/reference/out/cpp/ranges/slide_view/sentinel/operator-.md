...
|  |  |  |
| --- | --- | --- |
| friend constexpr ranges::range_difference_t<V>  operator-( const /\*iterator\*/<false>& x, const /\*sentinel\*/& y )      requires std::sized_sentinel_for<ranges::sentinel_t<V>, ranges::iterator_t<V>>; | (1) | (since C++23) |
| friend constexpr ranges::range_difference_t<V>  operator-( const /\*sentinel\*/& y, const /\*iterator\*/<false>& x )      requires std::sized_sentinel_for<ranges::sentinel_t<V>, ranges::iterator_t<V>>; | (2) | (since C++23) |
|  |  |  |
...
1) Equivalent to: return x.last_ele_ - y.end_;.2) Equivalent to: return y.end_ - x.last_ele_;.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/slide_view/sentinel/operator-&oldid=172660>"
