...
| template< class T >  concept common_range = ranges::range<T> && std::same_as<ranges::iterator_t<T>, ranges::sentinel_t<T>>; |  | (since C++20) |
|  |  |  |
...
- This page was last modified on 24 June 2024, at 20:47.