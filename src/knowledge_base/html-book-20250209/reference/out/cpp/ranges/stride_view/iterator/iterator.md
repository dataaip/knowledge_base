...
| constexpr /\*iterator\*/( /\*iterator\*/<!Const> i )      requires Const and          std::convertible_to<ranges::iterator_t<V>, ranges::iterator_t<Base>> and std::convertible_to<ranges::sentinel_t<V>, ranges::sentinel_t<Base>>; | (2) | (since C++23) |
| private:  constexpr /\*iterator\*/( /\*Parent\*/& parent,                          ranges::iterator_t<Base> current, ranges::range_difference_t<Base> missing = 0 ); | (3) | (exposition only\*) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/stride_view/iterator/iterator&oldid=156296>"
...
- This page was last modified on 4 August 2023, at 13:27.