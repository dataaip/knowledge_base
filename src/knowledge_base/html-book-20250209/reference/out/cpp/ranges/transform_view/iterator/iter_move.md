...
noexcept specification:noexcept(noexcept(std::invoke(\*i.parent_->fun_, \*i.current_)))where \*i.parent_->fun_ denotes the transformation function, i.current_ denotes the underlying iterator.
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/transform_view/iterator/iter_move&oldid=172695>"
...
- This page was last modified on 20 June 2024, at 22:14.