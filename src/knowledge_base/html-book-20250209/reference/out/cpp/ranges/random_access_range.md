...
| template< class T >  concept random_access_range = ranges::bidirectional_range<T> && std::random_access_iterator<ranges::iterator_t<T>>; |  | (since C++20) |
|  |  |  |
...
- This page was last modified on 24 June 2024, at 20:51.