...
| inline namespace /\* unspecified \*/ {  inline constexpr /\* unspecified \*/ begin = /\* unspecified \*/; } |  | (since C++20)  (customization point object) |
| Call signature |  |  |
| template< class T >      requires /\* see below \*/ constexpr std::input_or_output_iterator auto begin( T&& t ); |  | (since C++20) |
|  |  |  |
...
- This page was last modified on 8 September 2023, at 09:28.