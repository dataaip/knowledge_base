...
|  |  |  |
| --- | --- | --- |
| template< bool OtherConst >      requires std::sized_sentinel_for<ranges::sentinel_t<Base>,                                       ranges::iterator_t</\*maybe-const\*/<OtherConst, V>>>  friend constexpr ranges::range_difference_t</\*maybe-const\*/<OtherConst, V>>     operator-( const /\*iterator\*/<OtherConst>& x, const /\*sentinel\*/& y ); | (1) | (since C++20) |
| template< bool OtherConst >      requires std::sized_sentinel_for<ranges::sentinel_t<Base>,                                       ranges::iterator_t</\*maybe-const\*/<OtherConst, V>>>  friend constexpr ranges::range_difference_t</\*maybe-const\*/<OtherConst, V>>     operator-( const /\*sentinel\*/& y, const /\*iterator\*/<OtherConst>& x ); | (2) | (since C++20) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/elements_view/sentinel/operator-&oldid=172723>"
...
- This page was last modified on 21 June 2024, at 09:46.