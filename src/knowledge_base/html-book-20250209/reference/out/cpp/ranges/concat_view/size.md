...
|  |  |  |
| --- | --- | --- |
| constexpr auto size()      requires(sized_range<Views> && ...); | (1) | (since C++26) |
| constexpr auto size() const      requires(sized_range<const Views> && ...); | (2) | (since C++26) |
|  |  |  |
...
- This page was last modified on 29 September 2024, at 18:48.