...
|  |  |  |
| --- | --- | --- |
| friend constexpr bool      operator==( const /\*iterator\*/& x, const /\*iterator\*/& y ) noexcept; | (1) | (since C++23) |
| friend constexpr std::strong_ordering      operator<=>( const /\*iterator\*/& x, const /\*iterator\*/& y ) noexcept; | (2) | (since C++23) |
|  |  |  |

Compares the underlying iterators. Let `pos_` be the underlying index.

1) Equivalent to return x.pos_ == y.pos_;.2) Equivalent to return x.pos_ <=> y.pos_;.
...
|  |  |
| --- | --- |
| operator==(C++23) | compares a sentinel with an iterator returned from enumerate_view::begin   (function) |
...
- This page was last modified on 20 June 2024, at 19:39.