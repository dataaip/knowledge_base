...
noexcept specification:noexcept(std::invoke(\*parent_->fun_, \*std::get<Is>(inner_.current_)...))
...
|  |  |
| --- | --- |
| [operator[]](operator_at.html "cpp/ranges/adjacent transform view/iterator/operator at")(C++23) | accesses an element by index   (public member function) |

Retrieved from "https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/adjacent_transform_view/iterator/operator\*&oldid=151306"
...
- This page was last modified on 3 May 2023, at 07:10.