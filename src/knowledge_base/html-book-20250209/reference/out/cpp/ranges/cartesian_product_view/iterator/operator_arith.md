...
1) Equivalent to `next`();return \*this;2) Equivalent to ++\*this;3) Equivalent to auto tmp = \*this; ++\*this; return tmp;4) Equivalent to `prev`();return \*this;5) Equivalent to auto tmp = \*this; --\*this; return tmp;6) Sets the value of \*this to `ret`, where `ret` is:
...
The behavior is undefined if n is not in the range ``[ranges::distance(\*this, ranges::begin(\*parent_))`,`ranges::distance(\*this, ranges::end(\*parent_))`)`.7) Equivalent to \*this += -n; return \*this;.
...
1,4,6,7) \*this2) (none)3,5) a copy of \*this that was made before the change.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/cartesian_product_view/iterator/operator_arith&oldid=172636>"
...
- This page was last modified on 20 June 2024, at 20:04.