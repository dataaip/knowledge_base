...
1,2) The memory synchronization ordering is std::memory_order_seq_cst.3,4) The memory synchronization ordering is order. If order is one of std::memory_order_consume, std::memory_order_acquire and std::memory_order_acq_rel, the behavior is undefined.
...
- This page was last modified on 7 March 2024, at 22:31.