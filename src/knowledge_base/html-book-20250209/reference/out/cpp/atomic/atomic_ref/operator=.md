...
1) Equivalent to store(desired); return desired;. This overload participates in overload resolution only if std::is_const_v<T> is false.2) `atomic_ref` is not CopyAssignable.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_ref/operator%3D&oldid=179565>"
...
- This page was last modified on 12 January 2025, at 22:44.