...
|  |  |  |
| --- | --- | --- |
| T load( std::memory_order order              = std::memory_order_seq_cst ) const noexcept; | (1) | (since C++11) |
| T load( std::memory_order order              = std::memory_order_seq_cst ) const volatile noexcept; | (2) | (since C++11) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic/load&oldid=159442>"
...
- This page was last modified on 21 September 2023, at 01:59.