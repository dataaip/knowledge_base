...
5-8) The result may be an undefined address, but the operations otherwise have no undefined behavior. If `T` is not a complete object type, the program is ill-formed.
...
- This page was last modified on 29 April 2024, at 19:15.