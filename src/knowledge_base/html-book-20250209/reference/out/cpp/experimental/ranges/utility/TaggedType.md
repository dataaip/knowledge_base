...
| template< class T >  concept bool TaggedType = /\* implementation-defined \*/; |  | (ranges TS) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/ranges/utility/TaggedType&oldid=102181>"
