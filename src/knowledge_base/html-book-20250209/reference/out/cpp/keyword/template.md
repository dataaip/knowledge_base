...
|  |  |
| --- | --- |
| - `export` (mark a template definition exported) | (until C++11) |
| - `concept`, `requires` | (since C++20) |

Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/template&oldid=175651>"
...
- This page was last modified on 1 September 2024, at 12:27.