...
- `dynamic_cast` type conversion expression: as the declaration of the expression
...
- `static_cast`
- `reinterpret_cast`
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/dynamic_cast&oldid=174973>"
