...
- `inline` specifier for functions and variables(since C++17)

|  |  |
| --- | --- |
| - `inline` `namespace` definition | (since C++11) |

Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/inline&oldid=175029>"
...
- This page was last modified on 14 August 2024, at 00:53.