...
- `static_cast` type conversion expression: as the declaration of the expression
...
- `dynamic_cast`
- `reinterpret_cast`
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/static_cast&oldid=174974>"
