...
|  |  |
| --- | --- |
| - **lambda-declarator** that removes `const` qualification from parameters captured by copy | (since C++11) |

### See also

- `const`
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/mutable&oldid=175113>"
...
- This page was last modified on 14 August 2024, at 02:29.