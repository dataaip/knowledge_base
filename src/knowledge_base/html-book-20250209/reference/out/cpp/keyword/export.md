...
| **The keyword is unused and reserved.** | (since C++11) (until C++20) |
...
|  |  |
| --- | --- |
| - `template` (mark a template definition exported) | (until C++11) |
| - `import`, `module` | (since C++20) |

Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/export&oldid=176063>"
...
- This page was last modified on 13 September 2024, at 11:01.