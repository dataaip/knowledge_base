...
1) The specified heap is ``first`,`last`)`.2) The specified heap is r.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/pop_heap&oldid=177052>"
...
- This page was last modified on 14 October 2024, at 01:23.