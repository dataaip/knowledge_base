...
This algorithm is a more general form of `ranges::lower_bound`, which can be expressed in terms of `ranges::partition_point` with the predicate & { return std::invoke(pred, e, value); });.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/partition_point&oldid=150557>"
...
- This page was last modified on 15 April 2023, at 03:48.