...
1) Elements are compared using the given binary predicate p.2) Same as (1), but uses r as the source range, as if using [ranges::begin(r) as first and ranges::end(r) as last.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/mismatch&oldid=161496>"
...
- This page was last modified on 26 October 2023, at 16:40.