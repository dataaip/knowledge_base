...
| Helper types |  |  |
| template< class I1, class I2, class O >  using set_union_result = ranges::in_in_out_result<I1, I2, O>; | (3) | (since C++20) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/set_union&oldid=170807>"
...
- This page was last modified on 12 April 2024, at 16:55.