...
1) The source range elements are projected using the function object proj1, and the destination elements are projected using the function object proj2.2) Same as (1), but uses r as the source range and result_r as the destination range, as if using ranges::begin(r) as first, ranges::end(r) as last, ranges::begin(result_r) as result_first, and ranges::end(result_r) as result_last.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/partial_sort_copy&oldid=159532>"
...
- This page was last modified on 23 September 2023, at 23:50.