...
|  |
| --- |
| ```text template<class ForwardIt1, class ForwardIt2> constexpr //< since C++20 void iter_swap(ForwardIt1 a, ForwardIt2 b) {     using std::swap;     swap(*a, *b); } ``` |
...
- This page was last modified on 25 March 2024, at 23:49.