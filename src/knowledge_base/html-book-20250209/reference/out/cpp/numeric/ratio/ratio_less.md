...
|  |  |  |
| --- | --- | --- |
| template< class R1, class R2 >  constexpr bool ratio_less_v = ratio_less<R1, R2>::value; |  | (since C++17) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/ratio/ratio_less&oldid=176484>"
...
- This page was last modified on 24 September 2024, at 14:51.