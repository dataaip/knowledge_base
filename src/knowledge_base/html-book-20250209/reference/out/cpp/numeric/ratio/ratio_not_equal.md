...
| template< class R1, class R2 >  struct ratio_not_equal : std::integral_constant<bool, /\* see below \*/> { }; |  | (since C++11) |
|  |  |  |
...
|  |  |  |
| --- | --- | --- |
| template< class R1, class R2 >  constexpr bool ratio_not_equal_v = ratio_not_equal<R1, R2>::value; |  | (since C++17) |
|  |  |  |
...
|  |
| --- |
| ```text template< class R1, class R2 > struct ratio_not_equal : std::integral_constant <                               bool,                               !std::ratio_equal<R1, R2>                          > {}; ``` |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/ratio/ratio_not_equal&oldid=176481>"
...
- This page was last modified on 24 September 2024, at 14:42.