...
| template< class R1, class R2 >  struct ratio_greater : std::integral_constant<bool, /\* see below \*/> { }; |  | (since C++11) |
|  |  |  |
...
|  |  |  |
| --- | --- | --- |
| template< class R1, class R2 >  constexpr bool ratio_greater_v = ratio_greater<R1, R2>::value; |  | (since C++17) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/ratio/ratio_greater&oldid=176487>"
...
- This page was last modified on 24 September 2024, at 15:06.