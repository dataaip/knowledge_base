...
|  |  |  |
| --- | --- | --- |
| friend bool operator==( const student_t_distribution& lhs,                          const student_t_distribution& rhs ); | (1) | (since C++11) |
| friend bool operator!=( const student_t_distribution& lhs,                          const student_t_distribution& rhs ); | (2) | (since C++11)  (until C++20) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/student_t_distribution/operator_cmp&oldid=135815>"
