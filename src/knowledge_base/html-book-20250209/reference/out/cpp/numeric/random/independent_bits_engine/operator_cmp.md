...
|  |  |  |
| --- | --- | --- |
| friend bool operator==( const independent_bits_engine& lhs,                          const independent_bits_engine& rhs ); | (1) | (since C++11) |
| friend bool operator!=( const independent_bits_engine& lhs,                          const independent_bits_engine& rhs ); | (2) | (since C++11)  (until C++20) |
|  |  |  |
...
1) true if the engine adaptors are equivalent, false otherwise.2) true if the engine adaptors are not equivalent, false otherwise.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/independent_bits_engine/operator_cmp&oldid=132168>"
...
- This page was last modified on 7 August 2021, at 13:04.