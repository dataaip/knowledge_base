...
1,2) Assigns cx.real() and cx.imag() to the real and the imaginary parts of the complex number respectively. The copy assignment operator (1) is trivial when `T` is a floating-point type.(since C++23)3) Assigns x to the real part of the complex number. Imaginary part is set to zero.
...
- This page was last modified on 7 November 2023, at 19:38.