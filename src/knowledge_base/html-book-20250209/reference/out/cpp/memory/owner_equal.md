...
|  |  |  |
| --- | --- | --- |
| template< class T, class U >  bool operator()( const std::shared_ptr<T>& lhs, const std::shared_ptr<U>& rhs ) const noexcept; |  | (since C++26) |
| template< class T, class U >  bool operator()( const std::shared_ptr<T>& lhs, const std::weak_ptr<U>& rhs ) const noexcept; |  | (since C++26) |
| template< class T, class U >  bool operator()( const std::weak_ptr<T>& lhs, const std::shared_ptr<U>& rhs ) const noexcept; |  | (since C++26) |
| template< class T, class U >  bool operator()( const std::weak_ptr<T>& lhs, const std::weak_ptr<U>& rhs ) const noexcept; |  | (since C++26) |
|  |  |  |
...
|  |  |
| --- | --- |
| owner_equal(C++26) | provides owner-based equal comparison of shared pointers   (public member function of `std::shared_ptr<T>`) |
| owner_equal(C++26) | provides owner-based equal comparison of weak pointers   (public member function of `std::weak_ptr<T>`) |
...
- This page was last modified on 2 January 2024, at 21:57.