...
| destroy(until C++20) | destructs an object in allocated storage   (public member function of `std::allocator<T>`) |

Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/memory/scoped_allocator_adaptor/destroy&oldid=153614>"
...
- This page was last modified on 16 June 2023, at 01:55.