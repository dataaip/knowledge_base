...
|  |  |  |
| --- | --- | --- |
| static constexpr std::allocation_result<pointer, size_type>      allocate_at_least( Alloc& a, size_type n ); |  | (since C++23) |
|  |  |  |
...
- This page was last modified on 1 July 2024, at 02:03.