...
| --- | --- | --- | --- |
| LWG 3827 | C++11 | C programs no longer need the compatibility macro `__alignas_is_defined` since C23 | deprecated this macro in C++ |
...
- This page was last modified on 16 July 2024, at 21:42.