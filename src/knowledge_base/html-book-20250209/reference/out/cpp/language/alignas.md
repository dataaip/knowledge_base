...
|  |  |
| --- | --- |
| the headers <stdalign.h> and <cstdalign> do not define such macro. They do, however, define the macro constant __alignas_is_defined. | (until C++20) |
| the header <stdalign.h> does not define such macro. It does, however, define the macro constant __alignas_is_defined. | (since C++20) |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/language/alignas&oldid=175531>"
...
- This page was last modified on 27 August 2024, at 13:10.