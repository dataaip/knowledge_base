...
|  |  |
| --- | --- |
| - any member of the basic execution character set. | (until C++23) |
| - the ordinary literal encoding of any element of the basic literal character set. | (since C++23) |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/language/memory_model&oldid=179719>"
...
- This page was last modified on 15 January 2025, at 17:27.