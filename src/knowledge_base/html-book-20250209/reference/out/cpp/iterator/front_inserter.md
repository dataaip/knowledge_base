...
|  |
| --- |
| ```text template<class Container> std::front_insert_iterator<Container> front_inserter( Container& c ) {     return std::front_insert_iterator<Container>(c); } ``` |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/front_inserter&oldid=160097>"
...
- This page was last modified on 3 October 2023, at 14:54.