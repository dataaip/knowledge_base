...
|  |  |  |
| --- | --- | --- |
| template<   class Arg1,       class Arg2,      class Result > class pointer_to_binary_function : public std::binary_function<Arg1, Arg2, Result>; |  | (deprecated in C++11)  (removed in C++17) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/pointer_to_binary_function&oldid=156674>"
...
- This page was last modified on 14 August 2023, at 09:23.