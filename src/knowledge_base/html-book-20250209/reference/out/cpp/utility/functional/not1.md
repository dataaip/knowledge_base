...
| template< class Predicate >  constexpr std::unary_negate<Predicate> not1( const Predicate& pred ); |  | (since C++14)  (deprecated in C++17)  (removed in C++20) |
|  |  |  |
| --- | --- | --- |
|  |  |  |
...
- This page was last modified on 30 October 2023, at 12:56.