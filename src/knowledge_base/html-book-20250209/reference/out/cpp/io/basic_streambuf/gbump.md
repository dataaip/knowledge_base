...
| --- | --- | --- | --- |
| LWG 59 | C++98 | it was unclear whether `gbump` can be implemented as calling sbumpc count times (which may check underflow) | only add count to the get pointer |
...
- This page was last modified on 11 September 2023, at 11:20.