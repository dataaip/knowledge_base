...
|  |  |  |
| --- | --- | --- |
| template< class CharT, class Traits >  void swap( std::basic_filebuf<CharT,Traits>& lhs, std::basic_filebuf<CharT,Traits>& rhs ); |  | (since C++11) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_filebuf/swap2&oldid=156807>"
...
- This page was last modified on 16 August 2023, at 00:38.