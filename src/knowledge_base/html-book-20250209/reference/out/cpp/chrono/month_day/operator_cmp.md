...
1) x.month() == y.month() && x.day() == y.day()2) x.month() <=> y.month() != 0 ? x.month() <=> y.month() : x.day() <=> y.day()
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/month_day/operator_cmp&oldid=157108>"
...
- This page was last modified on 22 August 2023, at 02:35.