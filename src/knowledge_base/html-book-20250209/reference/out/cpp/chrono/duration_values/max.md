...
|  |  |  |
| --- | --- | --- |
| static constexpr Rep max(); |  | (since C++11)  (until C++20) |
...
|  |  |
| --- | --- |
| max[static] | returns the special duration value max   (public static member function of `std::chrono::duration<Rep,Period>`) |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/duration_values/max&oldid=161879>"
...
- This page was last modified on 1 November 2023, at 16:44.