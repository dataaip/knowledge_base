...
|  |  |  |
| --- | --- | --- |
| bool operator==( const type_info& rhs ) const; | (1) | (noexcept since C++11)  (constexpr since C++23) |
| bool operator!=( const type_info& rhs ) const; | (2) | (noexcept since C++11)  (until C++20) |
|  |  |  |
...
|  |  |
| --- | --- |
| before | checks whether the referred type precedes referred type of another `type_info` object in the implementation defined order, i.e. orders the referred types   (public member function) |
...
- This page was last modified on 10 July 2024, at 06:18.