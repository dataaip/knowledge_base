...
| bool operator!=( const type_index& rhs ) const noexcept; | (2) | (since C++11)  (until C++20) |
...
| std::strong_ordering operator<=>( const type_index& rhs ) const noexcept; | (7) | (since C++20) |
|  |  |  |

Compares the underlying std::type_info objects.

1,2) Checks whether the underlying std::type_info objects refer to the same type.3-7) Compares the underlying std::type_info objects as defined by an implementation-defined ordering. The comparison is done by type_info::before.
...
- This page was last modified on 13 October 2023, at 22:24.