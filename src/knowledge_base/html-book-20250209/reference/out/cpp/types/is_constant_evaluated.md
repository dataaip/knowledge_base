...
|  |
| --- |
| ```text // This implementation requires C++23 if consteval. constexpr bool is_constant_evaluated() noexcept {     if consteval     {         return true;     }     else      {         return false;     } } ``` |
...
- This page was last modified on 6 January 2025, at 08:17.