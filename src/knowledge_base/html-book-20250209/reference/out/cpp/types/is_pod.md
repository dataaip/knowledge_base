...
|  |  |  |
| --- | --- | --- |
| template< class T >  constexpr bool is_pod_v = is_pod<T>::value; |  | (since C++17)  (deprecated in C++20) |
|  |  |  |
...
|  |  |
| --- | --- |
| value[static] | true if `T` is a POD type, false otherwise   (public static member constant) |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_pod&oldid=169714>"
...
- This page was last modified on 9 February 2024, at 15:48.