...
|  |  |
| --- | --- |
| value[static] | true if `T` is an rvalue reference type, false otherwise   (public static member constant) |
...
|  |
| --- |
| ```text template<class T> struct is_rvalue_reference : std::false_type {}; template<class T> struct is_rvalue_reference<T&&> : std::true_type {}; ``` |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_rvalue_reference&oldid=176468>"
...
- This page was last modified on 24 September 2024, at 12:39.