...
| template< class T >  struct is_member_object_pointer; |  | (since C++11) |
|  |  |  |
...
|  |  |  |
| --- | --- | --- |
| template< class T >  constexpr bool is_member_object_pointer_v = is_member_object_pointer<T>::value; |  | (since C++17) |
|  |  |  |
...
|  |  |
| --- | --- |
| value[static] | true if `T` is a pointer to member object, false otherwise   (public static member constant) |
...
|  |
| --- |
| ```text template<class T> struct is_member_object_pointer : std::integral_constant<                                       bool,                                       std::is_member_pointer<T>::value &&                                       !std::is_member_function_pointer<T>::value                                   > {}; ``` |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_member_object_pointer&oldid=140416>"
...
- This page was last modified on 20 June 2022, at 04:00.