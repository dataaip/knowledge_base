...
|  |  |  |
| --- | --- | --- |
| template< class Mutex >  void swap( unique_lock<Mutex>& lhs,            unique_lock<Mutex>& rhs ) noexcept; |  | (since C++11) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/thread/unique_lock/swap2&oldid=156925>"
...
- This page was last modified on 17 August 2023, at 04:43.