...
|  |  |
| --- | --- |
| (destructor) | if the thread is joinable, then a stop is requested and the thread joins   (public member function of `std::jthread`) |
...
- This page was last modified on 24 October 2023, at 01:59.