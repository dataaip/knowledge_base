...
|  |  |  |
| --- | --- | --- |
| template< class R, class Alloc >  struct uses_allocator<std::promise<R>, Alloc> : std::true_type {}; |  | (since C++11) |
|  |  |  |
...
- This page was last modified on 23 October 2023, at 02:41.