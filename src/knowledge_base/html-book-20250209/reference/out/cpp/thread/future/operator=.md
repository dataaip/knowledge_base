...
1) Releases any shared state and move-assigns the contents of other to \*this. After the assignment, other.valid() == false and this->valid() will yield the same value as other.valid() before the assignment.2) std::future is not CopyAssignable.
...
- This page was last modified on 22 October 2023, at 09:03.