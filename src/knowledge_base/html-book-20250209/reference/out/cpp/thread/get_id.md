...
|  |  |
| --- | --- |
| get_id | returns the **id** of the thread   (public member function of `std::thread`) |
| C documentation for thrd_current | |

Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/thread/get_id&oldid=161141>"
...
- This page was last modified on 22 October 2023, at 09:38.