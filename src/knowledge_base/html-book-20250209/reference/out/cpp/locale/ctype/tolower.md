...
1,2) Public member function, calls the protected virtual member function `do_tolower` of the most derived class.3) Converts the character c to lower case if a lower case form is defined by this locale.4) For every character in the character array `[`beg`,`end`)`, for which a lower case form exists, replaces the character with that lower case form.
...
1,3) Lower case character or c if no lower case form is listed by this locale.2,4) end
...
- This page was last modified on 3 October 2023, at 09:45.