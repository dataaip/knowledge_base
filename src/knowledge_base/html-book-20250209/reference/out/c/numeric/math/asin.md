...
1-6) Computes the principal values of the arc sine of arg.7) Type-generic macro: If the argument has type long double, (3) (`asinl`) is called. Otherwise, if the argument has integer type or the type double, (2) (`asin`) is called. Otherwise, (1) (`asinf`) is called. If the argument is complex, then the macro invokes the corresponding complex function (casinf, casin, casinl).
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/asin&oldid=150034>"
...
- This page was last modified on 3 April 2023, at 09:05.