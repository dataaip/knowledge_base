...
1-3) Computes hyperbolic sine of arg.4) Type-generic macro: If the argument has type long double, `sinhl` is called. Otherwise, if the argument has integer type or the type double, `sinh` is called. Otherwise, `sinhf` is called. If the argument is complex, then the macro invokes the corresponding complex function (csinhf, csinh, csinhl).
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/sinh&oldid=172063>"
...
- This page was last modified on 23 May 2024, at 19:54.