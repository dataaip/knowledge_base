...
1-3) Computes the inverse hyperbolic tangent of arg.4) Type-generic macro: If the argument has type long double, `atanhl` is called. Otherwise, if the argument has integer type or the type double, `atanh` is called. Otherwise, `atanhf` is called. If the argument is complex, then the macro invokes the corresponding complex function (catanhf, catanh, catanhl).
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/atanh&oldid=172077>"
...
- This page was last modified on 23 May 2024, at 23:13.