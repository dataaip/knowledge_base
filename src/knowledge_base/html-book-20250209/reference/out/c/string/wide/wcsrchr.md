...
1) Finds the last occurrence of the wide character ch in the wide string pointed to by str.2) Type-generic function equivalent to (1). Let `T` be an unqualified wide character object type.
...
- This page was last modified on 18 June 2023, at 07:51.