...
* <tr><td>2024.12.24 <td>0.1             <td>brightl         <td>threadlocal关键词使用，解释说明
* </table>
*/
...
*/
#define THREADLOCAL_WORDS

/**
* @brief             _Thread_local(C23前)thread_local(C23起) - 线程存储期(C11起)
* @return  int       Return Description
*
* @note              Revision History
*/
int threadlocal_fn(void) {
#ifdef THREADLOCAL_WORDS
  /*
...
#endif // THREADLOCAL_WORDS  threadlocal 关键词  
