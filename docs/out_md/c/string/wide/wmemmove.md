...
1) Returns a copy of dest2) Returns zero on success, returns non-zero on error. Also, on error, fills the entire dst up to and not including dst+dstsz with null wide characters, L'\0' (unless dest is null or destsz is greater than RSIZE_MAX/sizeof(wchar_t))
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=c/string/wide/wmemmove&oldid=153731>"
...
- This page was last modified on 18 June 2023, at 12:57.