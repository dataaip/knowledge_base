# C keywords: _Thread_local (since C11)(deprecated in C23)
...
- thread storage-class specifier (since C11)
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=c/keyword/_Thread_local&oldid=177719>"
