...
1-3) Computes e (Euler's number "enwiki:E (mathematical constant)"), 2.7182818...) raised to the given power arg.4) Type-generic macro: If arg has type long double, `expl` is called. Otherwise, if arg has integer type or the type double, `exp` is called. Otherwise, `expf` is called. If arg is complex or imaginary, then the macro invokes the corresponding complex function (cexpf, cexp, cexpl).
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/exp&oldid=172008>"
