...
1-3) Computes the common (base-**10**) logarithm of arg.4) Type-generic macro: If arg has type long double, `log10l` is called. Otherwise, if arg has integer type or the type double, `log10` is called. Otherwise, `log10f` is called.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/log10&oldid=172043>"
...
- This page was last modified on 23 May 2024, at 07:34.