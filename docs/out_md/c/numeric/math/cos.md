...
1-6) Computes the cosine of arg (measured in radians).7) Type-generic macro: If the argument has type long double, (3) (`cosl`) is called. Otherwise, if the argument has integer type or the type double, (2) (`cos`) is called. Otherwise, (1) (`cosf`) is called. If the argument is complex, then the macro invokes the corresponding complex function (ccosf, ccos, ccosl).
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/cos&oldid=162278>"
...
- This page was last modified on 7 November 2023, at 19:43.