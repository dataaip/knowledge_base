...
1-6) Computes the cosine of `π·arg` measured in radians, thus regarding arg as a measurement in half-revolutions.7) Type-generic macro: calls the correct function based on the type of arg. If the argument has integer type, (2) (`cospi`) is called.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/cospi&oldid=150041>"
...
- This page was last modified on 3 April 2023, at 09:35.