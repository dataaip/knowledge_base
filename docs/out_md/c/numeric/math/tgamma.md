...
1-3) Computes the gamma function of arg.4) Type-generic macro: If arg has type long double, `tgammal` is called. Otherwise, if arg has integer type or the type double, `tgamma` is called. Otherwise, `tgammaf` is called.
