...
1-3) Computes the hyperbolic cosine of `arg`.4) Type-generic macro: If the argument has type long double, `coshl` is called. Otherwise, if the argument has integer type or the type double, `cosh` is called. Otherwise, `coshf` is called. If the argument is complex, then the macro invokes the corresponding complex function (ccoshf, ccosh, ccoshl).
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/cosh&oldid=172005>"
...
- This page was last modified on 23 May 2024, at 03:36.