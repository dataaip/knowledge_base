...
|  |  |  |
| --- | --- | --- |
| std::filesystem::file_type type() const noexcept; | (1) | (since C++17) |
| void type( std::filesystem::file_type type ) noexcept; | (2) | (since C++17) |
|  |  |  |
...
- This page was last modified on 7 December 2021, at 06:06.