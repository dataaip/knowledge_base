...
- The member types X::iterator and X::const_iterator are LegacyContiguousIterators(until C++20)`contiguous_iterator`s(since C++20)
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/named_req/ContiguousContainer&oldid=177776>"
...
- This page was last modified on 21 November 2024, at 11:07.