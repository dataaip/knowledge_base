...
- `reinterpret_cast` type conversion expression: as the declaration of the expression
...
- `dynamic_cast`
- `static_cast`
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/keyword/reinterpret_cast&oldid=174975>"
...
- This page was last modified on 13 August 2024, at 23:46.