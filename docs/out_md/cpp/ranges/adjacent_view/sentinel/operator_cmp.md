...
|  |  |  |
| --- | --- | --- |
| template< bool OtherConst >      requires std::sentinel_for<ranges::sentinel_t<Base>,                                 ranges::iterator_t</\*maybe-const\*/<OtherConst, V>>>  friend constexpr bool operator==( const /\*iterator\*/<OtherConst>& x, const /\*sentinel\*/& y ); |  | (since C++23) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/adjacent_view/sentinel/operator_cmp&oldid=172726>"
...
- This page was last modified on 21 June 2024, at 10:55.