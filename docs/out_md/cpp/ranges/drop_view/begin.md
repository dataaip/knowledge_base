...
|  |  |  |
| --- | --- | --- |
| constexpr auto begin()      requires (!(/\*simple-view\*/<V> &&                   ranges::random_access_range<const V> && ranges::sized_range<const V>)); | (1) | (since C++20) |
| constexpr auto begin() const      requires ranges::random_access_range<const V> && ranges::sized_range<const V>; | (2) | (since C++20) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/drop_view/begin&oldid=173574>"
...
- This page was last modified on 13 July 2024, at 08:00.