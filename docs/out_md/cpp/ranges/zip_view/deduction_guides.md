...
|  |  |  |
| --- | --- | --- |
| template< class... Rs >  zip_view( Rs&&... ) -> zip_view<views::all_t<Rs>...>; |  | (since C++23) |
|  |  |  |

The deduction guide is provided for std::ranges::zip_view to allow deduction from `range`s.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/zip_view/deduction_guides&oldid=139308>"
...
- This page was last modified on 17 April 2022, at 18:03.