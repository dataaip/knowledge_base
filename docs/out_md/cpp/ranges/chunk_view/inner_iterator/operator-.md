...
|  |  |  |
| --- | --- | --- |
| friend constexpr difference_type operator-( std::default_sentinel_t s,  const /\*inner-iterator\*/& i )      requires ranges::sized_sentinel_for<ranges::sentinel_t<V>, ranges::iterator_t<V>>; | (1) | (since C++23) |
| friend constexpr difference_type operator-( const /\*inner-iterator\*/& i,  std::default_sentinel_t s )      requires ranges::sized_sentinel_for<ranges::sentinel_t<V>, ranges::iterator_t<V>>; | (2) | (since C++23) |
|  |  |  |
...
                   ranges::end(i.parent_->base_) - \*i.parent_->current_);2) Equivalent to: return -(s - i);.
...
|  |  |
| --- | --- |
| operator++(C++23) | increments the iterator   (public member function) |

Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/chunk_view/inner_iterator/operator-&oldid=172669>"
...
- This page was last modified on 20 June 2024, at 21:14.