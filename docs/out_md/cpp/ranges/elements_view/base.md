# std::ranges::elements_view<V,N>::base
...
1) Copy constructs the result from the underlying view `base_`.2) Move constructs the result from the underlying view `base_`.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/elements_view/base&oldid=173587>"
...
- This page was last modified on 13 July 2024, at 11:07.