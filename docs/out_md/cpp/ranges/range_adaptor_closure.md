...
| template< class D >      requires std::is_object_v<D> && std::same_as<D, std::remove_cv_t<D>> class range_adaptor_closure {}; |  | (since C++23) |
|  |  |  |
...
- This page was last modified on 10 September 2024, at 13:23.