...
1) ++inner_; return \*this;2) auto tmp = \*this; ++\*this; return tmp;3) --inner_; return \*this;4) auto tmp = \*this; --\*this; return tmp;5) inner_ += n; return \*this;6) inner_ -= n; return \*this;
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/adjacent_transform_view/iterator/operator_arith&oldid=151311>"
...
- This page was last modified on 3 May 2023, at 07:58.