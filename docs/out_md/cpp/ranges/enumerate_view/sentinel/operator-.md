...
| [enumerate_view::**iterator**::operator[]](../iterator/operator_at.html "cpp/ranges/enumerate view/iterator/operator at") | | | | |
...
|  |  |  |
| --- | --- | --- |
| template< bool OtherConst >      requires std::sized_sentinel_for<                   ranges::sentinel_t<Base>,                   ranges::iterator_t</\*maybe-const\*/<OtherConst, V>>>  friend constexpr ranges::range_difference_t</\*maybe-const\*/<OtherConst, V>>     operator-( const /\*iterator\*/<OtherConst>& x, const /\*sentinel\*/& y ); | (1) | (since C++23) |
| template< bool OtherConst >      requires std::sized_sentinel_for<                   ranges::sentinel_t<Base>,                   ranges::iterator_t</\*maybe-const\*/<OtherConst, V>>>  friend constexpr ranges::range_difference_t</\*maybe-const\*/<OtherConst, V>>     operator-( const /\*sentinel\*/& y, const /\*iterator\*/<OtherConst>& x ); | (2) | (since C++23) |
|  |  |  |
...
1) x.base() - y.base()2) y.base() - x.base()
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/enumerate_view/sentinel/operator-&oldid=172628>"
...
- This page was last modified on 20 June 2024, at 19:50.