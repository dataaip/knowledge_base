...
| template< class R >  enumerate_view( R&& ) -> enumerate_view<views::all_t<R>>; |  | (since C++23) |
|  |  |  |

The deduction guide is provided for std::ranges::enumerate_view to allow deduction from `range`.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/enumerate_view/deduction_guides&oldid=172630>"
...
- This page was last modified on 20 June 2024, at 19:54.