...
| [enumerate_view::**iterator**::operator[]](operator_at.html "cpp/ranges/enumerate view/iterator/operator at") | | | | |
...
| friend constexpr difference_type      operator-( const /\* iterator \*/& i, const /\* iterator \*/& j ) noexcept; | (4) | (since C++23) |
|  |  |  |
...
1) auto temp = i; temp += n; return temp;2) return i + n;3) auto temp = i; temp -= n; return temp;4) return i.pos_ - j.pos_;
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/enumerate_view/iterator/operator_arith2&oldid=172623>"
...
- This page was last modified on 20 June 2024, at 19:40.