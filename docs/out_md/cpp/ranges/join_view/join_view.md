...
1) Default constructor. Value-initializes the underlying view. After construction, `base()` returns a copy of V().2) Initializes the underlying view with std::move(base).
...
- This page was last modified on 24 September 2021, at 00:31.