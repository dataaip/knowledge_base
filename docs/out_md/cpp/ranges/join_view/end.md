...
| constexpr auto end() const      requires ranges::input_range<const V> && std::is_reference_v<ranges::range_reference_t<const V>>; | (2) | (since C++20) |
|  |  |  |
...
1) sentinel which compares equal to the end iterator.2) iterator to the element following the last element.
...
- This page was last modified on 20 June 2024, at 12:56.