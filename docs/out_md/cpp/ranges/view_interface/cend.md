...
1) Let derived be a reference bound to static_cast<D&>(\*this). Equivalent to return ranges::cend(derived);.2) Same as (1), except that derived is static_cast<const D&>(\*this).
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/view_interface/cend&oldid=153351>"
...
- This page was last modified on 14 June 2023, at 02:54.