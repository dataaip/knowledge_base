...
| --- | --- |
| Member | Description |
| ranges::sentinel_t<V> `end_` (private) | the sentinel for the underlying `view` (exposition-only member object\*) |
...
- This page was last modified on 28 January 2025, at 12:20.