...
| constexpr auto begin() const      requires ranges::range<const ranges::zip_view<Views...>>; | (2) | (since C++23) |
|  |  |  |

Obtains the beginning iterator of `zip_transform_view`.

1) Equivalent to return /\*iterator\*/<false>(\*this, zip_.begin());.2) Equivalent to return /\*iterator\*/<true>(\*this, zip_.begin());.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/zip_transform_view/begin&oldid=138229>"
...
- This page was last modified on 16 February 2022, at 15:01.