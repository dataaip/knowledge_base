...
|  |  |  |
| --- | --- | --- |
| template< class R, class F >  transform_view( R&&, F ) -> transform_view<views::all_t<R>, F>; |  | (since C++20) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/transform_view/deduction_guides&oldid=144661>"
...
- This page was last modified on 28 October 2022, at 03:19.