...
| private:  constexpr /\*sentinel\*/( ranges::sentinel_t<V> end ); | (2) | (exposition only\*) |
|  |  |  |

Constructs a sentinel.

1) Default constructor. Value-initializes the underlying sentinel `end_` with ranges::sentinel_t<V>().2) A private constructor which is used by slide_view::end. This constructor is not accessible to users. Initializes `end_` with end.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/ranges/slide_view/sentinel/sentinel&oldid=156090>"
...
- This page was last modified on 1 August 2023, at 23:33.