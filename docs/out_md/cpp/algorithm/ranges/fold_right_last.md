...
2) Same as (1), except that uses r as the range, as if by using ranges::begin(r) as first and ranges::end(r) as last.3) Equivalent to:
...
An object of type std::optional<U> that contains the result of right-fold "enwiki:Fold (higher-order function)") of the given range over f.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/fold_right_last&oldid=171183>"
...
- This page was last modified on 23 April 2024, at 07:47.