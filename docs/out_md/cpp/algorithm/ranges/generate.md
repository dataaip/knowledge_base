...
1) Assigns the result of **successive** invocations of the function object gen to each element in the range ``first`,`last`)`.2) Same as (1), but uses r as the range, as if using [ranges::begin(r) as first and ranges::end(r) as last.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/generate&oldid=177270>"
...
- This page was last modified on 25 October 2024, at 13:19.