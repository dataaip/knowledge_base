...
If the range to search for (aka **needle**) is empty, that is first2 == last2, then the ranges::subrange{first1, first1} is returned.2) Same as (1) but the return type is ranges::borrowed_subrange_t<R1>.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/search&oldid=150603>"
...
- This page was last modified on 16 April 2023, at 11:45.