...
1) Equivalent to return {in, value};.2) Equivalent to return {std::move(in), std::move(value)};.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/in_value_result&oldid=170871>"
