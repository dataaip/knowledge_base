...
| in | a value (that is supposed to be an iterator) of type `I`. It is declared with `[[no_unique_address]]` attribute.   (public member object) |
| found | a boolean flag (that may show whether an appropriate range can be found) of type bool.   (public member object) |
...
1) Equivalent to return {in, found};.2) Equivalent to return {std::move(in), found};.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/return_types/in_found_result&oldid=170865>"
...
- This page was last modified on 13 April 2024, at 01:56.