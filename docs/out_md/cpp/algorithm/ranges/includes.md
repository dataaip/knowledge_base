...
1) Returns true if the projections of the sorted range ``first2`,`last2`)` is a [subsequence of the projections of the sorted range ``first1`,`last1`)`.2) Same as (1), but uses r1 and r2 as the source ranges, as if by using [ranges::begin(r1) and ranges::begin(r2) as first1 and first2 respectively, and ranges::end(r1) and ranges::end(r2) as last1 and last2 respectively.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/algorithm/ranges/includes&oldid=155059>"
...
- This page was last modified on 18 July 2023, at 11:59.