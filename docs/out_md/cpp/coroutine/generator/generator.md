...
1) The copy-constructor is deleted.2) The move-constructor that initializes the underlying `coroutine_` with std::exchange(other.coroutine_, {}), and the underlying stack of coroutine handles (`active_`) with std::exchange(other.active_, nullptr).
...
- This page was last modified on 6 November 2023, at 00:36.