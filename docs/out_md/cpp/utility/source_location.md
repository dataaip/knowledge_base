...
|  |  |
| --- | --- |
| #line | changes the source code's line number and, optionally, the current file name (preprocessing directive) |
...
- This page was last modified on 20 October 2024, at 13:41.