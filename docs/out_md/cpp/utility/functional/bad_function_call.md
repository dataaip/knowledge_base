...
1) Default constructor.2) Copy constructor. If \*this and other both have dynamic type `std::bad_function_call` then std::strcmp(what(), other.what()) == 0.
...
| --- | --- | --- | --- |
| LWG 2233 | C++11 | `what()` always returned the same explanatory string as std::exception::what() | returns its own explanatory string |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/bad_function_call&oldid=178143>"
...
- This page was last modified on 4 December 2024, at 00:27.