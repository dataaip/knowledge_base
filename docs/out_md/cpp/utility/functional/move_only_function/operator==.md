...
|  |  |  |
| --- | --- | --- |
| friend bool operator==( const std::move_only_function& f, std::nullptr_t ) noexcept; |  | (since C++23) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/utility/functional/move_only_function/operator%3D%3D&oldid=175648>"
...
- This page was last modified on 1 September 2024, at 12:07.