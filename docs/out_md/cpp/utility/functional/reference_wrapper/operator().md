...
|  |  |  |
| --- | --- | --- |
| template< class... ArgTypes >  typename std::result_of<T&(ArgTypes&&...)>::type     operator() ( ArgTypes&&... args ) const; |  | (since C++11)  (until C++17) |
| template< class... ArgTypes >  std::invoke_result_t<T&, ArgTypes...>     operator() ( ArgTypes&&... args ) const noexcept(/\* see below \*/); |  | (since C++17)  (constexpr since C++20) |
|  |  |  |
| --- | --- | --- |
|  |  |  |
...
- This page was last modified on 17 April 2024, at 14:39.