...
| template< class R, class... Args >  void swap( std::function<R(Args...)>& lhs, std::function<R(Args...)>& rhs ) noexcept; |  | (since C++11) |
|  |  |  |
...
- This page was last modified on 13 October 2023, at 23:26.