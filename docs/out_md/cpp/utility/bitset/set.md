...
|  |  |  |
| --- | --- | --- |
| bitset& set(); | (1) | (noexcept since C++11)  (constexpr since C++23) |
| bitset& set( std::size_t pos, bool value = true ); | (2) | (constexpr since C++23) |
|  |  |  |

Sets all bits to true or sets one bit to specified value.

1) Sets all bits to true.2) Sets the bit at position pos to the value value.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/utility/bitset/set&oldid=178322>"
...
- This page was last modified on 10 December 2024, at 18:07.