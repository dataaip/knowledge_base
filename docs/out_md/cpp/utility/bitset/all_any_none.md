...
1) Checks if all bits are set to true.2) Checks if any bits are set to true.3) Checks if none of the bits are set to true.
...
1) true if all bits are set to true, otherwise false.2) true if any of the bits are set to true, otherwise false.3) true if none of the bits are set to true, otherwise false.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/utility/bitset/all_any_none&oldid=171728>"
...
- This page was last modified on 13 May 2024, at 19:55.