...
1,2) Performs binary shift left. The (2) version is destructive, i.e. performs the shift to the current object.3,4) Performs binary shift right. The (4) version is destructive, i.e. performs the shift to the current object.
...
1,3) New bitset object containing the shifted bits.2,4) \*this
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/utility/bitset/operator_ltltgtgt&oldid=171732>"
...
- This page was last modified on 13 May 2024, at 20:00.