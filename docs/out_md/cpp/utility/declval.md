...
|  |  |  |
| --- | --- | --- |
| template< class T >  typename std::add_rvalue_reference<T>::type declval() noexcept; |  | (since C++11)  (until C++14)  (unevaluated-only) |
...
|  |
| --- |
| ```text template<typename T> typename std::add_rvalue_reference<T>::type declval() noexcept {     static_assert(false, "declval not allowed in an evaluated context"); } ``` |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/utility/declval&oldid=177822>"
...
- This page was last modified on 23 November 2024, at 16:19.