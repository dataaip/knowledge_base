...
|  |  |  |
| --- | --- | --- |
| template< class U >   constexpr T value_or( U&& default_value ) const&; | (1) | (since C++17) |
| template< class U >   constexpr T value_or( U&& default_value ) &&; | (2) | (since C++17) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/utility/optional/value_or&oldid=161811>"
...
- This page was last modified on 30 October 2023, at 13:15.