...
| template< class T >  concept pair-like =     tuple-like<T> && std::tuple_size_v<std::remove_cvref_t<T>> == 2; | (2) | (since C++23)  (exposition only\*) |
|  |  |  |
...
| operator PairLike | converts the `subrange` to a ******pair-like****** type   (public member function of `std::ranges::subrange<I,S,K>`) |
...
- This page was last modified on 21 June 2024, at 14:37.