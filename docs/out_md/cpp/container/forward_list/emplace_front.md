...
| template< class... Args >  reference emplace_front( Args&&... args ); |  | (since C++17) |
|  |  |  |
| --- | --- | --- |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/container/forward_list/emplace_front&oldid=156307>"
