...
Equivalent to returnextents().**fwd-prod-of-extents**(extents_type::rank());.
...
| required_span_size | returns the required size of the mapping   (public member function of `std::layout_stride::mapping<Extents>`) |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/container/mdspan/layout_right/mapping/required_span_size&oldid=178816>"
...
- This page was last modified on 27 December 2024, at 04:37.