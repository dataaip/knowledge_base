...
|  |  |  |
| --- | --- | --- |
| allocator_type get_allocator() const; |  | (noexcept since C++11) (constexpr since C++20) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/container/vector/get_allocator&oldid=162063>"
...
- This page was last modified on 5 November 2023, at 11:06.