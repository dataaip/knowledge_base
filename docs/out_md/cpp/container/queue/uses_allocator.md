...
| template< class T, class Container, class Alloc >  struct uses_allocator<std::queue<T, Container>, Alloc> : std::uses_allocator<Container, Alloc>::type {}; |  | (since C++11) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/container/queue/uses_allocator&oldid=142271>"
...
- This page was last modified on 21 August 2022, at 17:14.