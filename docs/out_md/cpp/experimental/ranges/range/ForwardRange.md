...
| template< class T >  concept bool ForwardRange =     InputRange<T> && ForwardIterator<ranges::iterator_t<T>>; |  | (ranges TS) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/ranges/range/ForwardRange&oldid=155559>"
