...
| template< class T >  concept bool Range =      requires(T&& t) {          ranges::begin(t); /\* not necessarily equality-preserving (see below) \*/          ranges::end(t); }; |  | (ranges TS) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/ranges/range/Range&oldid=155564>"
...
- This page was last modified on 26 July 2023, at 23:29.