...
| template< class I >  concept bool Iterator =      requires(I i) {          { \*i } -> auto&&; // Requires: i is dereferenceable      } &&     WeaklyIncrementable<I>; |  | (ranges TS) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/ranges/iterator/Iterator&oldid=155537>"
...
- This page was last modified on 26 July 2023, at 22:31.