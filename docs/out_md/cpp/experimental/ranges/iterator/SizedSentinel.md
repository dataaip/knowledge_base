...
| template< class S, class I >  concept bool SizedSentinel =      Sentinel<S, I> &&      !ranges::disable_sized_sentinel<std::remove_cv_t<S>, std::remove_cv_t<I>> &&      requires(const I& i, const S& s) {          { s - i } -> Same<ranges::difference_type_t<I>>&&;          { i - s } -> Same<ranges::difference_type_t<I>>&&; }; | (1) | (ranges TS) |
| template< class S, class I >  constexpr bool disable_sized_sentinel = false; | (1) | (ranges TS) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/ranges/iterator/SizedSentinel&oldid=155551>"
...
- This page was last modified on 26 July 2023, at 23:10.