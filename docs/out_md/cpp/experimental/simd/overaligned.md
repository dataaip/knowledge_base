...
| template< std::size_t N >  struct overaligned_tag {};    template< std::size_t N > inline constexpr overaligned_tag<N> overaligned{}; |  | (parallelism TS v2) |
|  |  |  |
...
- This page was last modified on 1 August 2023, at 10:14.