...
| template< class Key, class Compare, class Alloc, class Pred >  void erase_if( std::set<Key, Compare, Alloc>& c, Pred pred ); |  | (library fundamentals TS v2) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/experimental/set/erase_if&oldid=98561>"
...
- This page was last modified on 28 January 2018, at 20:29.