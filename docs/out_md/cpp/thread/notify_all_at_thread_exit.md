...
| --- | --- | --- | --- |
| LWG 2140 | C++11 | the call to `notify_all_at_thread_exit` synchronized with calls to functions waiting on cond | updated the synchronization requirement |
...
- This page was last modified on 13 March 2024, at 23:39.