...
|  |  |
| --- | --- |
| try_lock_for | attempts to lock (i.e., takes ownership of) the associated TimedLockable mutex, returns if the mutex has been unavailable for the specified time duration   (public member function of `std::unique_lock<Mutex>`) |
...
- This page was last modified on 23 October 2023, at 10:02.