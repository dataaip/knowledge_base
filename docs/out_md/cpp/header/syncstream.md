...
| `syncbuf` (C++20) | std::basic_syncbuf<char> (typedef) |
| `wsyncbuf` (C++20) | std::basic_syncbuf<wchar_t> (typedef) |
| `osyncstream` (C++20) | std::basic_osyncstream<char> (typedef) |
| `wosyncstream` (C++20) | std::basic_osyncstream<wchar_t> (typedef) |
| Functions | |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/header/syncstream&oldid=180083>"
...
- This page was last modified on 3 February 2025, at 01:16.