...
|  |
| --- |
| ```text template<class T> valarray<T> sin(const valarray<T>& va) {     valarray<T> other = va;     for (T& i : other)         i = sin(i);       return other; // proxy object may be returned } ``` |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/valarray/sin&oldid=160817>"
...
- This page was last modified on 17 October 2023, at 03:16.