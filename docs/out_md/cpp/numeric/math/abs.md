...
|  |  |
| --- | --- |
| Overload (6) of `std::abs` for std::intmax_t is provided in <cinttypes> if and only if std::intmax_t is an extended integer type. | (since C++11) |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/math/abs&oldid=163174>"
...
- This page was last modified on 19 November 2023, at 14:25.