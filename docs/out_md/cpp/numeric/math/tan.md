...
| --- | --- | --- |
|  | (1) |  |
| float       tan ( float num );  double      tan ( double num ); long double tan ( long double num ); |  | (until C++23) |
...
| long double tanl( long double num ); | (3) | (since C++11)  (constexpr since C++26) |
| SIMD overload (since C++26) |  |  |
| Defined in header `<simd>` |  |  |
| template< /\*math-floating-point\*/ V >  constexpr /\*deduced-simd-t\*/<V>             tan ( const V& v_num ); | (S) | (since C++26) |
...
|  |  |
| --- | --- |
| S) The SIMD overload performs an element-wise `std::tan` on v_num. (See **math-floating-point** and **deduced-simd-t** for their definitions.) | (since C++26) |
...
- This page was last modified on 15 September 2023, at 01:42.