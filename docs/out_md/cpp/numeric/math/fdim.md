...
| template< class V0, class V1 >  constexpr /\*math-common-simd-t\*/<V0, V1>             fdim ( const V0& v_x, const V1& v_y ); | (S) | (since C++26) |
...
|  |  |
| --- | --- |
| S) The SIMD overload performs an element-wise `std::fdim` on v_xand v_y. (See **math-common-simd-t** for its definition.) | (since C++26) |
...
- This page was last modified on 15 October 2023, at 09:22.