...
1) Returns the **a** distribution parameter. It defines the minimum possibly generated value. The default value is ​0​.2) Returns the **b** distribution parameter. It defines the maximum possibly generated value. The default value is std::numeric_limits<IntType>::max().
...
1) The **a** distribution parameter.2) The **b** distribution parameter.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/uniform_int_distribution/params&oldid=151422>"
...
- This page was last modified on 6 May 2023, at 00:01.