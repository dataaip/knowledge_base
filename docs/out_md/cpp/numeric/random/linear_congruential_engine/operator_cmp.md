...
|  |  |  |
| --- | --- | --- |
| friend bool operator==( const linear_congruential_engine& lhs,                          const linear_congruential_engine& rhs ); | (1) | (since C++11) |
| friend bool operator!=( const linear_congruential_engine& lhs,                          const linear_congruential_engine& rhs ); | (2) | (since C++11)  (until C++20) |
|  |  |  |
...
1) true if the engines are equal, false otherwise.2) true if the engines are not equal, false otherwise.
...
- This page was last modified on 16 November 2020, at 10:12.