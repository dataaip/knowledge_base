# std::binomial_distribution<IntType>::max
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/binomial_distribution/max&oldid=132206>"
