...
|  |  |  |
| --- | --- | --- |
| friend bool operator==( const discard_block_engine& lhs,                          const discard_block_engine& rhs ); | (1) | (since C++11) |
| friend bool operator!=( const discard_block_engine& lhs,                          const discard_block_engine& rhs ); | (2) | (since C++11)  (until C++20) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/discard_block_engine/operator_cmp&oldid=132160>"
