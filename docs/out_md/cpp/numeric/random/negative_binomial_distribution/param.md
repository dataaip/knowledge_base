# std::negative_binomial_distribution<IntType>::param
...
1) Returns the associated parameter set.2) Sets the associated parameter set to params.
...
1) The associated parameter set.2) (none)

### Complexity

Constant.

Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/negative_binomial_distribution/param&oldid=132425>"
