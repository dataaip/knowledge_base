# std::negative_binomial_distribution<IntType>::min
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/negative_binomial_distribution/min&oldid=132426>"
