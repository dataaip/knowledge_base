...
Returns the n parameter the distribution was constructed with. It specifies the degrees of freedom "enwiki:Degrees of freedom (statistics)") of the distribution. The default value is 1.0.
