# std::chi_squared_distribution<RealType>::param
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/random/chi_squared_distribution/param&oldid=135781>"
