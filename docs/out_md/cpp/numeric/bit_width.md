...
| template< class T >  constexpr int bit_width( T x ) noexcept; |  | (since C++20) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/bit_width&oldid=178985>"
