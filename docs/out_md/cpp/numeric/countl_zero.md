...
| template< class T >  constexpr int countl_zero( T x ) noexcept; |  | (since C++20) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/numeric/countl_zero&oldid=178988>"
