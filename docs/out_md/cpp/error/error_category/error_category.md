...
1) Constructs the error category object.2) Copy constructor is deleted. `error_category` is neither MoveConstructible nor CopyConstructible.
...
- This page was last modified on 10 May 2021, at 16:15.