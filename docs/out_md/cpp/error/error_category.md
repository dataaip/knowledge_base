...
| operator==operator!=operator<operator<=>(removed in C++20)(removed in C++20)(C++20) | compares two error categories   (function) |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/error/error_category&oldid=170168>"
...
- This page was last modified on 14 March 2024, at 00:51.