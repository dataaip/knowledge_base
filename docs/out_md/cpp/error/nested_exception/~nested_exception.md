...
|  |  |  |
| --- | --- | --- |
| virtual ~nested_exception() = default; |  | (since C++11)  (constexpr since C++26) |
|  |  |  |

Destroys the nested exception object.

Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/error/nested_exception/%7Enested_exception&oldid=177852>"
...
- This page was last modified on 24 November 2024, at 06:32.