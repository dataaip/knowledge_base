...
|  |  |  |
| --- | --- | --- |
| nested_exception& operator=( const nested_exception& other ) noexcept = default; |  | (since C++11)  (constexpr since C++26) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/error/nested_exception/operator%3D&oldid=177853>"
...
- This page was last modified on 24 November 2024, at 06:33.