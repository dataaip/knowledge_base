...
1) Default constructor. what() returns an implementation-defined string.2) Copy constructor. Initializes the contents with those of other. If \*this and other both have dynamic type `std::exception` then std::strcmp(what(), other.what()) == 0.
...
- This page was last modified on 24 November 2024, at 06:08.