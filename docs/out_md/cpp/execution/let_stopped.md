...
| execution::sender auto let_stopped( execution::sender auto input,                                      std::invocable auto function ); |  | (since C++26) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/execution/let_stopped&oldid=176777>"
