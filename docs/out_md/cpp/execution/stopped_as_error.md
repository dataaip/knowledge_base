...
| template< std::move_constructible Error >  execution::sender auto stopped_as_error( execution::sender auto snd, Error err ); |  | (since C++26) |
|  |  |  |
...
- This page was last modified on 4 October 2024, at 10:29.