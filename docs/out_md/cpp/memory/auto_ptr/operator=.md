...
|  |  |  |
| --- | --- | --- |
| auto_ptr& operator=( auto_ptr& r ) throw(); | (1) | (deprecated in C++11)  (removed in C++17) |
| template< class Y >  auto_ptr& operator=( auto_ptr<Y>& r ) throw(); | (2) | (deprecated in C++11)  (removed in C++17) |
| auto_ptr& operator=( auto_ptr_ref<T> m ) throw(); | (3) | (deprecated in C++11)  (removed in C++17) |
|  |  |  |
...
- This page was last modified on 29 June 2023, at 02:10.