...
|  |  |  |
| --- | --- | --- |
| template< class Y >   bool owner_equal( const std::weak_ptr<Y>& other ) const noexcept; | (1) | (since C++26) |
| template< class Y >  bool owner_equal( const std::shared_ptr<Y>& other ) const noexcept; | (2) | (since C++26) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/memory/weak_ptr/owner_equal&oldid=165924>"
...
- This page was last modified on 15 December 2023, at 19:45.