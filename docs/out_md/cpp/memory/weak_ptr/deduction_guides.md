...
| template< class T >  weak_ptr( std::shared_ptr<T> ) -> weak_ptr<T>; |  | (since C++17) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/memory/weak_ptr/deduction_guides&oldid=160322>"
...
- This page was last modified on 8 October 2023, at 06:54.