...
| template< class T, class D >  void swap( std::unique_ptr<T, D>& lhs, std::unique_ptr<T, D>& rhs ) noexcept; |  | (since C++11)  (constexpr since C++23) |
|  |  |  |
...
- This page was last modified on 25 December 2020, at 06:15.