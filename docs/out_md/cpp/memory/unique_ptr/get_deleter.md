...
|  |  |  |
| --- | --- | --- |
| Deleter& get_deleter() noexcept; |  | (since C++11)  (constexpr since C++23) |
| const Deleter& get_deleter() const noexcept; |  | (since C++11)  (constexpr since C++23) |
|  |  |  |
...
- This page was last modified on 10 October 2023, at 10:43.