...
|  |  |  |
| --- | --- | --- |
| explicit operator bool() const noexcept; |  | (since C++11)  (constexpr since C++23) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/memory/unique_ptr/operator_bool&oldid=180172>"
...
- This page was last modified on 5 February 2025, at 00:49.