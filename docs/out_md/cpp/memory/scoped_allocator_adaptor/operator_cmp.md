...
| template< class OuterAlloc1, class OuterAlloc2, class... InnerAllocs >  bool operator==( const scoped_allocator_adaptor<OuterAlloc1, InnerAllocs...>& lhs, const scoped_allocator_adaptor<OuterAlloc2, InnerAllocs...>& rhs ) noexcept; |  | (since C++11) |
| template< class OuterAlloc1, class OuterAlloc2, class... InnerAllocs >  bool operator!=( const scoped_allocator_adaptor<OuterAlloc1, InnerAllocs...>& lhs, const scoped_allocator_adaptor<OuterAlloc2, InnerAllocs...>& rhs ) noexcept; |  | (since C++11)  (until C++20) |
|  |  |  |
...
1) Returns true if lhs and rhs are equal, false otherwise.2) Returns true if lhs and rhs are not equal, false otherwise.
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/memory/scoped_allocator_adaptor/operator_cmp&oldid=153617>"
...
- This page was last modified on 16 June 2023, at 02:57.