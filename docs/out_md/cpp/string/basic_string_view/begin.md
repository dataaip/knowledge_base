...
| begincbegin(C++11) | returns an iterator to the beginning   (public member function of `std::basic_string<CharT,Traits,Allocator>`) |

Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string_view/begin&oldid=153321>"
...
- This page was last modified on 13 June 2023, at 13:07.