...
- Calling non-const member functions on the string, excluding [operator[]](operator_at.html "cpp/string/basic string/operator at"), at(), front(), back(), begin(), rbegin(), end() and rend()(since C++11).
