...
| begincbegin | returns an iterator to the beginning   (public member function of `std::basic_string_view<CharT,Traits>`) |

Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/string/basic_string/begin&oldid=172766>"
...
- This page was last modified on 22 June 2024, at 17:38.