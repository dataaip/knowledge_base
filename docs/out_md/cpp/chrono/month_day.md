...
|  |  |
| --- | --- |
| (constructor) | constructs a `month_day`   (public member function) |
| monthday | retrieve the stored month and day values   (public member function) |
| ok | checks if the `month_day` is valid   (public member function) |
...
- This page was last modified on 3 September 2023, at 23:58.