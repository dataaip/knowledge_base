...
|  |  |
| --- | --- |
| nametarget | accesses the name and target of this `time_zone_link`   (public member function) |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/time_zone_link&oldid=161658>"
