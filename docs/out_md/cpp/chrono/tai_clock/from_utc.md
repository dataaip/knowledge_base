...
|  |  |  |
| --- | --- | --- |
| template< class Duration >  static std::chrono::tai_time<std::common_type_t<Duration, std::chrono::seconds>>     from_utc( const std::chrono::utc_time<Duration>& ) noexcept; |  | (since C++20) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/tai_clock/from_utc&oldid=161637>"
...
- This page was last modified on 28 October 2023, at 10:07.