...
|  |  |  |
| --- | --- | --- |
| template< class CharT, class Traits, class Duration, class Alloc = std::allocator<CharT> >  std::basic_istream<CharT, Traits>&      from_stream( std::basic_istream<CharT, Traits>& is, const CharT\* fmt,                   std::chrono::gps_time<Duration>& tp,                    std::basic_string<CharT, Traits, Alloc>\* abbrev = nullptr, std::chrono::minutes\* offset = nullptr ); |  | (since C++20) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/gps_clock/from_stream&oldid=145837>"
...
- This page was last modified on 25 December 2022, at 21:24.