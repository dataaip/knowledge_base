...
|  |  |  |
| --- | --- | --- |
| template< class Duration >  static std::chrono::utc_time<std::common_type_t<Duration, std::chrono::seconds>>     to_utc( const std::chrono::gps_time<Duration>& t ) noexcept; |  | (since C++20) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/gps_clock/to_utc&oldid=161587>"
...
- This page was last modified on 28 October 2023, at 07:35.