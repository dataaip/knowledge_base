...
| to_time_t[static] | converts a system clock time point to ****std::time_t****   (public static member function of `std::chrono::system_clock`) |
| C documentation for time_t | |

Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/chrono/c/time_t&oldid=161520>"
...
- This page was last modified on 27 October 2023, at 01:08.