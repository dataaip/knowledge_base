...
| template< class Duration >  std::chrono::leap_second_info     get_leap_second_info( const std::chrono::utc_time<Duration>& ut ); |  | (since C++20) |
|  |  |  |
...
- This page was last modified on 28 October 2023, at 23:14.