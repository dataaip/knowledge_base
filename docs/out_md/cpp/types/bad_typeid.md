...
1) Default constructor.2) Copy constructor. If \*this and other both have dynamic type `std::bad_typeid` then std::strcmp(what(), other.what()) == 0.(since C++11)
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/types/bad_typeid&oldid=177867>"
...
- This page was last modified on 24 November 2024, at 12:10.