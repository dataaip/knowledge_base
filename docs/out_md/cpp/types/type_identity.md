...
|  |
| --- |
| ```text template<class T> struct type_identity { using type = T; }; ``` |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/types/type_identity&oldid=171046>"
...
- This page was last modified on 19 April 2024, at 04:23.