...
|  |  |  |
| --- | --- | --- |
| template< class T >  constexpr bool is_scoped_enum_v = is_scoped_enum<T>::value; |  | (since C++23) |
|  |  |  |
...
|  |  |
| --- | --- |
| value[static] | true if `T` is a scoped enumeration type, false otherwise   (public static member constant) |
...
|  |
| --- |
| ```text template<typename E> struct is_scoped_enum : std::bool_constant<requires {     requires std::is_enum_v<E>;     requires !std::is_convertible_v<E, std::underlying_type_t<E>>; }> {}; ``` |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_scoped_enum&oldid=151324>"
...
- This page was last modified on 3 May 2023, at 14:27.