...
|  |
| --- |
| ```text template<class T> struct is_compound : std::integral_constant<bool, !std::is_fundamental<T>::value> {}; ``` |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_compound&oldid=169523>"
...
- This page was last modified on 3 February 2024, at 05:48.