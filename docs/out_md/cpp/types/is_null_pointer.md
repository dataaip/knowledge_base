...
|  |
| --- |
| ```text template<class T> struct is_null_pointer : std::is_same<std::nullptr_t, std::remove_cv_t<T>> {}; ``` |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/types/is_null_pointer&oldid=179502>"
...
- This page was last modified on 11 January 2025, at 12:58.