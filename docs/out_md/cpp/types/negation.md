...
|  |  |
| --- | --- |
| value[static] | true if `B` has a member ::value that is false when explicitly converted to bool, false otherwise   (public static member constant) |
...
|  |
| --- |
| ```text template<class B> struct negation : std::bool_constant<!bool(B::value)> { }; ``` |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/types/negation&oldid=176460>"
...
- This page was last modified on 24 September 2024, at 12:18.