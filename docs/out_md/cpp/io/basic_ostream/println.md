...
1) Equivalent to:
std::print(os, "{}\n", std::format(os.getloc(), fmt, args...));2) Equivalent to:
std::print(os, "\n");
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/io/basic_ostream/println&oldid=178340>"
...
- This page was last modified on 11 December 2024, at 15:07.