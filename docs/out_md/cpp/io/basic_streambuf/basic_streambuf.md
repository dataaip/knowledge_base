...
|  |  |
| --- | --- |
| (constructor) | constructs a `basic_filebuf` object   (public member function of `std::basic_filebuf<CharT,Traits>`) |
...
- This page was last modified on 13 October 2023, at 08:52.