...
|  |  |  |
| --- | --- | --- |
| protected:  char_type\* pbase() const; | (1) |  |
| protected:  char_type\* pptr() const; | (2) |  |
| protected:  char_type\* epptr() const; | (3) |  |
|  |  |  |
...
- This page was last modified on 28 February 2023, at 09:14.