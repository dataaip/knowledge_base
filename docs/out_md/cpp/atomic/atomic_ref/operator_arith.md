...
1) Performs atomic pre-increment. Equivalent to return fetch_add(1) + 1;.2) Performs atomic post-increment. Equivalent to return fetch_add(1);.3) Performs atomic pre-decrement. Equivalent to return fetch_sub(1) - 1;4) Performs atomic post-decrement. Equivalent to return fetch_sub(1);.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_ref/operator_arith&oldid=179602>"
...
- This page was last modified on 13 January 2025, at 14:54.