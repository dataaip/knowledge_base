...
1) Constructs an `atomic_ref` object referencing the object obj. If obj is not aligned to `required_alignment`, the behavior is undefined.2) Constructs an `atomic_ref` object referencing the object referenced by ref.
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_ref/atomic_ref&oldid=179445>"
...
- This page was last modified on 10 January 2025, at 00:18.