...
|  |  |  |
| --- | --- | --- |
| value_type exchange( value_type desired,  std::memory_order order = std::memory_order_seq_cst ) const noexcept; |  | (constexpr since C++26) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_ref/exchange&oldid=179567>"
...
- This page was last modified on 12 January 2025, at 22:57.