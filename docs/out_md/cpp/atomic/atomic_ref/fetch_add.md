...
| value_type fetch_add( difference_type arg,  std::memory_order order = std::memory_order_seq_cst ) const noexcept; |  | (constexpr since C++26) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic_ref/fetch_add&oldid=179596>"
...
- This page was last modified on 13 January 2025, at 14:23.