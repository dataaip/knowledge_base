...
|  |  |  |
| --- | --- | --- |
| void wait( T old, std::memory_order order =                        std::memory_order_seq_cst ) const noexcept; | (1) | (since C++20)  (constexpr since C++26) |
| void wait( T old,  std::memory_order order = std::memory_order_seq_cst ) const volatile noexcept; | (2) | (since C++20) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/atomic/atomic/wait&oldid=116005>"
...
- This page was last modified on 8 February 2020, at 07:08.