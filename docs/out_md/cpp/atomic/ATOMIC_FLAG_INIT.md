...
| --- | --- | --- | --- |
| LWG 2159 | C++11 | it was unclear whether `ATOMIC_FLAG_INIT` can be used with other initialization contexts | other usages are not guaranteed |
...
- This page was last modified on 17 October 2024, at 18:13.