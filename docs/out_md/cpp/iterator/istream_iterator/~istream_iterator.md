...
|  |  |
| --- | --- |
| If std::is_trivially_destructible<T>::value is `true`, then this destructor is a trivial destructor. | (since C++11) |

Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/istream_iterator/%7Eistream_iterator&oldid=127627>"
...
- This page was last modified on 22 March 2021, at 10:52.