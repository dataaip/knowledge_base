...
|  |  |  |
| --- | --- | --- |
| friend constexpr counted_iterator operator+(  std::iter_difference_t<I> n, const counted_iterator& x )         requires std::random_access_iterator<I>; |  | (since C++20) |
|  |  |  |
...
- This page was last modified on 29 September 2023, at 23:47.