...
1) Checks if the underlying lengths are equal.2) Compares the underlying lengths with operator `<=>`.
...
1) x.count() == y.count()2) y.count() <=> x.count()
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/counted_iterator/operator_cmp&oldid=159838>"
...
- This page was last modified on 29 September 2023, at 23:31.