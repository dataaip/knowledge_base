...
| template< class I >      concept forward_iterator =          std::input_iterator<I> &&          std::derived_from</\*ITER_CONCEPT\*/<I>, std::forward_iterator_tag> &&          std::incrementable<I> && std::sentinel_for<I, I>; |  | (since C++20) |
|  |  |  |
...
Retrieved from "<https://en.cppreference.com/mwiki/index.php?title=cpp/iterator/forward_iterator&oldid=171720>"
...
- This page was last modified on 13 May 2024, at 13:31.